## 
 ...
 # Description: 
 # 
 # Adds a public command and a dcc command to allow the bot to perform 
 # dns and reverse lookup of IPv6 hosts and ip's. 
 # 
 ## 
 # 
 # History: 
 # 
 # (09/25/03):v1.4  -  Fixed a possible exploit 
 # 
 # (10/07/02):v1.3  -  Fixed more checking and utilization of nslookup tool 
 #                  -  Fixed interpretation of different variations on 
 #                     the nslookup tool 
 # 
 # (09/13/02):v1.2  -  Fixed checking of nslookup tool which could launch an 
 #                     interactive session of it thus making eggdrop consume 
 #                     alot of cpu from loading of script 
 # 
 #                  -  Changed lookup type to 'AAAA' instead of 'ANY' 
 #                     for hostnames 
 # 
 # (09/12/02):v1.1  -  Added proper formatting to given 
 #                     ipv6 addresses that contain "::" in them 
 #                     (that is, insert the necessary 0's to make it 
 #                     proper format) 
 # 
 # (09/05/02):v1.0  -  Initial Release 
 # 
 ## 
 # 
 # Usage: 
 ...
 #               ex1: !ipv6dns 3ffe:b80:50f:0:0:0:0:1 
 #               ex2: !ipv6dns 3ffe:b80:50f::1 
 #               ex3: !ipv6dns my.host6.net 
 # 
 # - From partyline type: .ipv6dns <IPv6-host/ip> 
 #                   ex1: .ipv6dns 3ffe:b80:50f:0:0:0:0:1 
 #                   ex2: .ipv6dns 3ffe:b80:50f::1 
 #                   ex3: .ipv6dns my.host6.net 
 # 
