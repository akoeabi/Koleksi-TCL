...
set onlinetext "1,5(0,4 °=- usuRadio FM ONLINE NOW -=° 1,5)"
set onlinetopic "1,2(0,12 usuRadio Radio 1,2)1,5(0,4 °=- Back up again -=° 1,5)1,7(1,8 usuRadio Radio 1,7)"

set streamtext "1,2(0,12 usuRadio Radio 1,2)1,5(0,4 !request: Artist/Title/Msg ( Jenis Music : POP, Jazz, KPOP, Alternatif, RandB ) - ( INFO: usuRadio Radio : Is Tha Funky And Cool Station !! ) 1,5)1,7(1,8 Tune In: http://radio-usu.dalnet.ca:8000/listen.pls 1,7)"

set advertisetext "1,2(0,12 usuRadio Radio 1,2)1,5(0,4 Mau Dengarkan Radio? Hanya Di usuRadio Station 1,5)1,7(1,8 Streaming @ : http://radio-usu.dalnet.ca:8000/listen.pls 1,7)"
...
putserv "notice $target :Usu@usuRadio.us"
}
...
puts $temp $nickname
close $temp
poststuff privmsg "15,1.:4: usuRadio Radio 4,1:15,1:. Dj Now Change to  $djnickname - msg  $djnickname if you got any request 15,1.:4: usuRadio Radio 4,1:15,1:."
putserv "notice $djnickname :15,1.:4: usuRadio Radio 4,1:15,1:. You are now Dj usuRadio Station Radio. Have A Nice Work.... 15,1.:4: usuRadio Radio 4,1:15,1:."
...
if { $streamstatus == "1" } { poststuff privmsg "15,1.:4: usuRadio Radio 4,1:15,1:. $djnickname is now rocking the turntables, enjoy 15,1.:4: usuRadio Radio 4,1:15,1:." } else {
putserv "privmsg $nickname :15,1.:4: usuRadio Radio 4,1:15,1:. this has not been announced because the radio is currentlfy offline 15,1.:4: usuRadio Radio 4,1:15,1:." }
}}
...
close $sock
putserv "notice $target :0,1( 9usuRadio Radio 0) There are currently $repl unique people listening, the listener maximum is $maxl, our user peak was at $curhigh listeners, the listening time average is $avgtime 0,1( 9usuRadio Radio 0)"
}}
...
close $temp
putserv "privmsg #USU :0,1( 9usuRadio Radio 0)  New Request From: $nick Song Title & msg: $arg Has been sent to dj $djnick 0,1( 9usuRadio Radio 0)"
putserv "privmsg $djnick :0,1( 9usuRadio Radio 0)  New Request From: $nick Song Title & msg: $arg Has been sent to dj $djnick 0,1( 9usuRadio Radio 0)"
putserv "privmsg $nick :0,1( 9usuRadio Radio 0) Request: $arg ke Dj $djnick is being processed. Happy Listening To Our Radio  0,1( 9usuRadio Radio 0)"
} else {
putserv "notice $nick :0,1( 9usuRadio Radio 0) Maaf yah $nick , kayaknya radio lagi offline 0,1( 9usuRadio Radio 0)" }
}}
...
putserv "notice $target :0,1( 9usuRadio Radio 0) $djnickname In to Studio. Tune In Go To Address: http://radio-usu.dalnet.ca:8000/listen.pls  Request A Song? Type !request  artist - song name <msg> 0,1( 9usuRadio Radio 0)"
} else {
...
putserv "notice $target :0,1( 9usuRadio Radio 0) There are currently $repl unique people listening, the listener maximum is $maxl, our user peak was at $curhigh listeners 0,1( 9usuRadio Radio 0)"
...
putserv "notice $target :you can contact the usuRadio team by USU on $irc, via aim at $aim and with icq by the uin $icq."
}}
close $sock
}}
...
if {$streamstatus == 1} {
putserv "notice $target :0,1( 9usuRadio Radio 0) playing =- $songtitle 0By 19$djnick"
} else {
putserv "notice $target :0,1( 9usuRadio Radio 0) server is currently offline, sorry"
}}}
close $sock
}}
...
poststuff privmsg "0,1( 9usuRadio Radio 0) $stitle$sgenre 10ONLINE 4@ [lindex $surl 1] with [lindex $bitrate 1]kbits $onlinetext"
if {$urltopic == 1} { poststuff topic "0,1( 9usuRadio Radio 0) $stitle$sgenre 10ONLINE 4@ [lindex $surl 1] with [lindex $bitrate 1]kbits $onlinetext" }
}}
...
if {$oldcurlist != $repl} {
poststuff privmsg "0,1( 9usuRadio Radio 0) Listener usuRadio FM Now [lindex $repl 1] ($currentl) People"
}}
...
poststuff privmsg "1,2(0,12Now playing: [lrange $cursong 1 [llength $cursong]] 1,2)3,3(1,8 $stitle 3,3_0,12 !request Title/Song 3,3_1,8 $sgenre 3,3-1,8 Streaming @ : http://radio-usu.dalnet.ca:8000/listen.pls 3,3x"
}
...
putlog "Shoutcast.tcl Modidy By Javu@usuRadio.us 2013 Loaded..."