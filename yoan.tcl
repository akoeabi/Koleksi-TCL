####################################################################
##  Yoan [Yoan] tcl v.1.0 by.Yoan Yoan@London.com                 ##
##  Modified Wednesday, October 11, 2001 5:03:34 AM / (c)-Yoan tcl##
##  ------------------------------------------------------------  ##
##  REQUIRES EGGDROP 1.3+ with toolkit.tcl and alltools.tcl       ##
####################################################################

#--------------------------------------------------------------------------------------
putlog "\002\[4Y3oan\]\002 ::::::"
putlog "\002\[4Y3oan\]\002 :::    Initializing Yoan TCL    :::"
putlog "\002\[4Y3oan\]\002 ::::::"
#--------------------------------------------------------------------------------------
putlog "Loading Now........." 
...
### How often to backup Lidokidz files. (in minutes) 
set min 120 
...
putlog "*** Can't load Yoan's tcl -- At least Eggdrop v1.3.7 required" 
return 0 
} 
...
foreach x [timers] { 
if {[lindex $x 1] == "Yoan_autosave"} { 
killtimer [lindex $x 2] 
} 
} 

#foreach u [utimers] { 
# if {[lindex $u 1] == "Yoan_check"} { 
# killutimer [lindex $u 2] 
# } 
#} 

bind join G|G * join_greet 
bind dcc p|p Yoanhelp dcc_badzhelp 
bind dcc p|p YoanHelp dcc_badzhelp 
bind pub p|p ${CC}Yoanhelp pub_badzhelp 
bind pub p|p ${CC}Yoanhelp pub_badzhelp 
...
bind pub n|n ${CC}tsunami pub_tsunami 
bind pub n|n ${CC}kill pub_kill 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 This command requires you to authenticate yourself. Please /msg $botnick auth <password>" 
return 0 
} 
if {$rest == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}+v <nick>" 
return 0 
} 
if {[onchan $rest $chan] == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $rest is not on the channel." 
return 0 
} 
if {[isvoice $rest $chan] == 1} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $rest is already +v" 
} 
...
if {$rest == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}+l <limit>" 
return 0 
} 
...
if {$rest == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}+k <key>" 
return 0 
} 
...
if {$rest == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}+b <hostmask>" 
return 0 
} 
...
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! Notice $rest" 
return 0 
} 
if {$rest==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: notice <nick> <msg>" 
} 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 echo is only available via dcc chat." 
} 
...
puts $fd "### \[4Y3oan] Created on [unixtime]" 
close $fd 
putlog "\002\[4Y3oan]\002 Creating url file information." 
} 
if {[file exists $urlpath]} { 
...
puts $fd "### \[4Y3oan] Created on [unixtime]" 
close $fd 
putlog "\002\[4Y3oan]\002 Creating greet file information" 
} 
if {[file exists $greetpath]} { 
...
puts $fd "### \[4Y3oan] Created on [unixtime]" 
close $fd 
putlog "\002\[4Y3oan]\002 Creating email file information" 
} 
if {[file exists $emailpath]} { 
...
greet_read 
putlog "Loading \[4Y3oan] Greet File..." 
} 
if {(![info exists url]) || ([array size url] == 0)} { 
url_read 
putlog "Loading \[4Y3oan] URL File..." 
} 
if {(![info exists email]) || ([array size email] == 0)} { 
email_read 
putlog "Loading \[4Y3oan] E-Mail File..." 
} 


timer $min badjoelz_autosave 
proc badjoelz_autosave {} { 
global min 
putlog "\002\[4Y3oan]\002 Automatically backing up greet information" 
greet_save 
putlog "\002\[4Y3oan]\002 Automatically backing up email information" 
email_save 
putlog "\002\[4Y3oan]\002 Automatically backing up url information" 
url_save 
timer $min Yoan_autosave 
} 

proc dcc_flsave {hand idx arg} { 
putcmdlog "#$hand# flsave" 
putlog "\002\[4Y3oan]\002 ${hand} requested backup of greet information" 
greet_save 
putlog "\002\[4Y3oan]\002 ${hand} requested backup of email information" 
email_save 
putlog "\002\[4Y3oan]\002 ${hand} requested backup of url information" 
url_save 
} 
...
unset start 
close $fd 
putlog "\002\[4Y3oan]\002 saving url information complete." 
return "url_save" 
} 
} 
...
close $fd 
putlog "\002\[4Y3oan]\002 saving greet information complete." 
} 
} 
...
unset start 
close $fd 
putlog "\002\[4Y3oan]\002 saving email information complete." 
return "email_save" 
} 
} 
...
if {$greetinfo == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}greet <new greet>" 
return 0 
} 
if {[lindex $greetinfo 0] == "none"} { 
set greet([string tolower $hand]) "" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# greet $greetinfo" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Your Greet msg has been removed." 
return 0 
} 
set greet([string tolower $hand]) "$greetinfo" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# greet $greetinfo" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Setting for '\002greet\002' is now $greetinfo" 
} 
...
if {$greetinfo == ""} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: .greet <new greet>" 
return 0 
} 
if {[lindex $greetinfo 0] == "none"} { 
set greet([string tolower $hand]) "" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# greet $greetinfo" 
putdcc $idx "\002\[4Y3oan]\002 Your Greet msg has been removed." 
return 0 
} 
set greet([string tolower $hand]) "$greetinfo" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# greet $greetinfo" 
putdcc $idx "\002\[4Y3oan]\002 Setting for '\002greet\002' is now $greetinfo" 
} 
...
if {$emailinfo == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}email <new email>" 
return 0 
} 
if {[lindex $emailinfo 0] == "none"} { 
set email([string tolower $hand]) "" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# email $emailinfo" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Your email msg has been removed." 
return 0 
} 
set email([string tolower $hand]) "$emailinfo" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# email $emailinfo" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Setting for '\002email\002' is now $emailinfo" 
} 
...
if {$emailinfo == ""} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: email <new email>" 
return 0 
} 
if {[lindex $emailinfo 0] == "none"} { 
set email([string tolower $hand]) "" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# email $emailinfo" 
putdcc $idx "\002\[4Y3oan]\002 Your email msg has been removed." 
return 0 
} 
set email([string tolower $hand]) "$emailinfo" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# email $emailinfo" 
putdcc $idx "\002\[4Y3oan]\002 Setting for '\002email\002' is now $emailinfo" 
} 
...
if {($emailinfo == "") || ($user == "")} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}chemail <new email>" 
return 0 
} 
if {![validuser $user]} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 no such user." 
return 0 
} 
if {[lindex $emailinfo 0] == "none"} { 
set email([string tolower $user]) "" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# chemail $user $emailinfo" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 ${user}'s email msg has been removed." 
return 0 
} 
set email([string tolower $user]) "$emailinfo" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# chemail $user $emailinfo" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 ${user}'s Setting for '\002email\002' is now $emailinfo" 
} 
...
if {($emailinfo == "") || ($user == "")} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: ${CC}chemail <new email>" 
return 0 
} 
if {![validuser $user]} { 
putdcc $idx "\002\[4Y3oan]\002 no such user." 
return 0 
} 
if {[lindex $emailinfo 0] == "none"} { 
set email([string tolower $user]) "" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# chemail $user $emailinfo" 
putdcc $idx "\002\[4Y3oan]\002 ${user}'s email msg has been removed." 
return 0 
} 
set email([string tolower $user]) "$emailinfo" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# chemail $user $emailinfo" 
putdcc $idx "\002\[4Y3oan]\002 ${user}'s Setting for '\002email\002' is now $emailinfo" 
} 
...
if {($greetinfo == "") || ($user == "")} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}chgreet <new greet>" 
return 0 
} 
if {![validuser $user]} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 no such user." 
...
putcmdlog "\002\[4Y3oan]\002 #${hand}# chgreet $user $greetinfo" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 ${user}'s greet msg has been removed." 
return 0 
} 
set greet([string tolower $user]) "$greetinfo" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# chgreet $user $greetinfo" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 ${user}'s Setting for '\002greet\002' is now $greetinfo" 
} 
...
if {($greetinfo == "") || ($user == "")} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: ${CC}chgreet <new greet>" 
return 0 
} 
if {![validuser $user]} { 
putdcc $idx "\002\[4Y3oan]\002 no such user." 
...
set greet([string tolower $user]) "" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# chgreet $user $greetinfo" 
putdcc $idx "\002\[4Y3oan]\002 ${user}'s greet msg has been removed." 
return 0 
} 
set greet([string tolower $user]) "$greetinfo" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# chgreet $user $greetinfo" 
putdcc $idx "\002\[4Y3oan]\002 ${user}'s Setting for '\002greet\002' is now $greetinfo" 
} 
...
if {$urlinfo == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}url <new url>" 
return 0 
} 
if {[lindex $urlinfo 0] == "none"} { 
set url([string tolower $user]) "" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# url $urlinfo" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Your url msg has been removed." 
return 0 
} 
set url([string tolower $hand]) "$urlinfo" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# url $urlinfo" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Setting for '\002url\002' is now $urlinfo" 
} 
...
if {$urlinfo == ""} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: .url <new url>" 
return 0 
} 
if {[lindex $urlinfo 0] == "none"} { 
set url([string tolower $hand]) "" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# url $urlinfo" 
putdcc $idx "\002\[4Y3oan]\002 Your url msg has been removed." 
return 0 
} 
set url([string tolower $hand]) "$urlinfo" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# url $urlinfo" 
putdcc $idx "\002\[4Y3oan]\002 Setting for '\002url\002' is now $urlinfo" 
} 
...
if {($urlinfo == "") || ($user == "")} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}churl <new url>" 
return 0 
} 
if {![validuser $user]} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 no such user." 
...
if {[lindex $urlinfo 0] == "none"} { 
set url([string tolower $user]) "" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# churl $user $urlinfo" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 ${user}'s url msg has been removed." 
return 0 
} 
set url([string tolower $user]) "$urlinfo" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# churl $user $urlinfo" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 ${user}'s Setting for '\002url\002' is now $urlinfo" 
} 
...
if {($urlinfo == "") || ($user == "")} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: ${CC}churl <new url>" 
return 0 
} 
if {![validuser $user]} { 
putdcc $idx "\002\[4Y3oan]\002 no such user." 
...
set url($user) "" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# churl $user $urlinfo" 
putdcc $idx "\002\[4Y3oan]\002 ${user}'s url msg has been removed." 
return 0 
} 
set url(${user}) "$urlinfo" 
putcmdlog "\002\[4Y3oan]\002 #${hand}# churl $user $urlinfo" 
putdcc $idx "\002\[4Y3oan]\002 ${user}'s Setting for '\002url\002' is now $urlinfo" 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Information about $user" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Current Time : [ctime [unixtime]] $timezone" 
if {[validuser $user] == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 No such user." 
return 0 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Last Online : $last" 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 E-Mail Address : $email([string tolower $user])" 
} 
} 
if {!$urlyes} { 
if {$url([string tolower $user]) != ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Web Address : $url([string tolower $user])" 
} 
} 
if {!$greetyes} { 
if {$greet([string tolower $user]) != ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Greet : $greet([string tolower $user])" 
} 
} 
if {[getuser $user INFO] != ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Info : [getuser $user INFO]" 
} 
} 
...
if {$user == ""} {set user $hand} 
putdcc $idx "\002\[4Y3oan]\002 Information about $user" 
putdcc $idx "\002\[4Y3oan]\002 Current Time : [ctime [unixtime]] $timezone" 
if {[validuser $user] == 0} { 
putdcc $idx "\002\[4Y3oan]\002 No such user." 
return 0 
} 
...
putdcc $idx "\002\[4Y3oan]\002 Last Online : $last" 
set emailyes 0;set urlyes 0;set greetyes 0 
if {![info exists url([string tolower $user])]} {set urlyes 1} 
if {![info exists email([string tolower $user])]} {set emailyes 1} 
...
if {!$emailyes} { 
if {$email([string tolower $user]) != ""} { 
putdcc $idx "\002\[4Y3oan]\002 E-Mail Address : $email([string tolower $user])" 
} 
} 
if {!$urlyes} { 
if {$url([string tolower $user]) != ""} { 
putdcc $idx "\002\[4Y3oan]\002 Web Address : $url([string tolower $user])" 
} 
} 
if {!$greetyes} { 
if {$greet([string tolower $user]) != ""} { 
putdcc $idx "\002\[4Y3oan]\002 Greet : $greet([string tolower $user])" 
} 
} 
if {[getuser $user INFO] != ""} { 
putdcc $idx "\002\[4Y3oan]\002 Info : [getuser $user INFO]" 
} 
} 
...
if {$rest == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}seen <handle>" 
return 0 
} 
if {[validuser $handle] == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 No such user in my userlist." 
return 0 
} 
if {[string tolower $handle] == [string tolower $nick]} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 You are here." 
return 0 
} 
if {[onchan $handle $chan] == 1} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $handle is currently on $chan." 
return 0 
} 
set lastseen [getuser $handle LASTON] 
if {$lastseen == ""} {puthelp "NOTICE $nick :\002\[4Y3oan]\002 $handle was never here";return 0} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $nick, I last saw $handle $output ago" 
} 
## pub cmd seen -- stop 
...
if {$pw == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: /msg $botnick auth <password>" 
return 0 
} 
if {[matchattr $hand Q] == 1} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 You are already Authenticated." 
return 0 
} 
set ch [passwdok $hand ""] 
if {$ch == 1} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 No password set. Type /msg $botnick pass <password>" 
return 0 
} 
if {[passwdok $hand $pw] == 1} { 
chattr $hand +Q 
putcmdlog "\002\[4Y3oan]\002 #$hand# auth ..." 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Authentication successful!" 
} 
if {[passwdok $hand $pw] == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Authentication failed!" 
} 
} 
## msg cmd auth -- stop 
...
if {[matchattr $hand Q] == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 You never authenticated." 
return 0 
} 
if {[passwdok $hand $rest] == 1} { 
chattr $hand -Q 
putcmdlog "\002\[4Y3oan]\002 #$hand# deauth ..." 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 DeAuthentication successful!" 
} 
if {[passwdok $hand $rest] == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 DeAuthentication failed!" 
} 
} 
## msg cmd deauth -- stop 
...
if {[matchattr $hand Q] == 1} { 
chattr $hand -Q 
putlog "\002\[4Y3oan]\002 $nick has signed off, automatic deauthentication." 
} 
if {[matchattr $hand Q] == 0} { 
return 0 
} 
...
if {[matchattr $hand Q] == 1} { 
chattr $hand -Q 
putlog "\002\[4Y3oan]\002 $nick has parted $chan ." 
} 
if {[matchattr $hand Q] == 0} { 
return 0 
} 
...
global vers 
putcmdlog "\002\[4Y3oan]\002 #$hand# about Yoan.tcl" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 \26Yoan.tcl\26 $vers by Yoan < Yoan@London.com > Ngangkang Co." 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 4Y3oan-Satisfaction Guaranteed-4Y3oan-Ngangkang Co(c)- 4Y3oan." 
} 
...
global vers 
putcmdlog "\002\[4Y3oan]\002 #$hand# about Yoan.tcl" 
putdcc $idx "\002\[4Y3oan]\002 \26Yoan.tcl\26 $vers by Yoan < Yoan@London.com >" 
putdcc $idx "\002\[4Y3oan]\002 4Y3oan-Satisfaction Guaranteed-4Y3oan-Ngangkang Co(c)-4Y3oan" 
} 
## dcc cmd about - stop 

## public cmd version -- start 
proc pub_version {nick uhost hand chan rest} { 
putcmdlog "\002\[4Y3oan]\002 #$hand# version" 
global vers 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 \26Yoan.tcl\26 $vers" 
} 
...
global vers 
putcmdlog "\002\[4Y3oan]\002 #$hand# version" 
putdcc $idx "\002\[4Y3oan]\002 \26Yoan.tcl\26 $vers" 
} 
## dcc cmd version -- stop 

## public cmd help -- start 
proc pub_help {nick uhost hand chan rest} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 help is only available via dcc chat." 
} 
## public cmd help -- stop 

## public cmd badzhelp -- start 
proc pub_badzhelp {nick uhost hand chan rest} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 help is only available via dcc chat." 
} 
## public cmd yoanhelp -- stop 

## dcc cmd Yoanhelp -- start 
proc dcc_badzhelp {hand idx args} { 
global botnick version vers 
set tn "\002\[4Y3oan]\002" 
set args [lindex $args 0] 
global CC NC 
if {$args == ""} { 
putdcc $idx "$tn \26Yoan.tcl\26 ${vers}, ENF0RCE < Yoan@London.com >" 
...
putcmdlog "$tn #$hand# Yoanhelp seen" 
putdcc $idx "$tn \#\#\# seen" 
...
## dcc cmd Yoanhelp -- stop 

## dcc cmd wi -- start 
proc dcc_wi {hand idx arg} { 
global botnick 
if {$arg == ""} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: whois <handle>" 
return 0 
} 
...
putdcc $idx "\002\[4Y3oan]\002 Usage: mub <#channel>" 
} 
} 
## dcc cmd mub -- stop 
...
putdcc $idx "\002\[4Y3oan]\002 Usage: massunban <#channel>" 
} 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 SOCK NICK HOST TYPE" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 ---- --------- ----------------- ----" 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $sock $user $host $type" 
putcmdlog "\002\[4Y3oan]\002 #$hand# dccstat" 
} 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 -chrec is only available via dcc chat." 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 debug is only available via dcc chat." 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 unloadmodule is only available via dcc chat." 
} 
## public cmd unloadmodule -- stop 

## public cmd loadmodule -- start 
proc pub_loadmodule {nick uhost hand chan rest} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 loadmodule is only available via dcc chat." 
} 
## public cmd loadmodule -- stop 

## public cmd modules -- start 
proc pub_modules {nick uhost hand chan rest} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 modules is only available via dcc chat." 
} 
## public cmd modules -- stop 

## public cmd simul -- start 
proc pub_simul {nick uhost hand chan rest} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 simul is only available via dcc chat." 
} 
...
if {($bot == "") || ($bflags == "")} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}botattr <bot> <flags> \[channel\]" 
return 0 
} 
if {[validuser $bot] == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 No such bot!" 
return 0 
} 
if {[matchattr $bot b] == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $bot is not a bot" 
return 0 
} 
if {$chan != ""} { 
if {[validchan $chan]} { 
putcmdlog "\002\[4Y3oan]\002 #$hand# botattr $bot $bflags $chan" 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 botattr $bot \002\[\002${bflags}\002\]\002 $chan" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Global Flags for $bot are \002\[\002${globalflags}\002\]\002" 
if {$chanflags != "-"} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Channel \002\"\002${chan}\002\"\002 Flags for $bot are \002\[\002${chanflags}\002\]\002" 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $bot does not have any channel specific flags." 
} 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $chan is not a valid channel" 
} 
} else { 
putcmdlog "\002\[4Y3oan]\002 #$hand# botattr $bot $bflags" 
botattr $bot $bflags 
set bflags [getuser $bot BOTFL] 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 botattr $bot \002\[\002${bflags}\002\]\002" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Global Flags for $bot are now \002\[\002${bflags}\002\]\002" 
} 
} 
...
if {$channel == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}+chan <#channel>" 
return 0 
} 
...
if {[validchan $channel]} { 
putcmdlog "\002\[4Y3oan]\002 #$hand# -chan $channel" 
channel remove $channel 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Channel $channel removed from the bot." 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 This includes any channel specific bans you set." 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 That channel doesnt exist!" 
} 
} 
## public cmd -chan -- stop 
...
if {$channel == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}+chan <#channel> \[option-list\]" 
return 0 
} 
if {[validchan $channel]} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Your already in $channel" 
} else { 
if {[string first # $channel]!=0} { 
set channel "#$channel" 
} 
putcmdlog "\002\[4Y3oan]\002 #$hand# +chan $channel $options" 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 binds is only available via dcc chat." 
} 
## public cmd binds -- stop 

## public cmd reset -- start 
proc pub_reset {nick uhost hand chan rest} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 reset is only available via dcc chat." 
} 
## public cmd reset -- stop 

## public cmd banner -- start 
proc pub_banner {nick uhost hand chan rest} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 banner is only available via dcc chat." 
} 
...
putserv "MODE $chan +b" 
putcmdlog "\002\[4Y3oan]\002 #$hand# (${chan}) resetbans" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Resetting bans on $chan..." 
return 0 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $chan is an invalid channel." 
return 0 
} 
} 
if {$chan == ""} { 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Resetting bans on $i" 
} 
} 
foreach x [channels] { 
putserv "MODE $x +b" 
} 
putcmdlog "\002\[4Y3oan]\002 #$hand# resetbans" 
} 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 flush is only available via dcc chat." 
} 
## public cmd flush -- stop 

## public cmd set -- start 
proc pub_set {nick uhost hand chan rest} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 set is only available via dcc chat." 
} 
## public cmd set -- stop 
...
putcmdlog "\002\[4Y3oan]\002 #$hand# chanload" 
loadchannels 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Reloading all dynamic channel settings." 
} 
...
putcmdlog "\002\[4Y3oan]\002 #$hand# chansave" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Saving all dynamic channel settings." 
savechannels 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Writing channel file ..." 
} 
...
set options [lindex $rest 1] 
if {($channel == "") || ($options == "")} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}chanset #<channel> <option...>" 
return 0 
} 
if {[validchan $channel]} { 
putcmdlog "\002\[4Y3oan]\002 #$hand# chanset $channel $options" 
channel set $channel $options 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Successfully set modes \{ $options \} on $channel" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Changes to $channel are not permanent." 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 No such channel." 
} 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Writing user file... Writing channel file ... Restarting ..." 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Writing user & channel file... Rehashing.. Userfile loaded, unpacking..." 
} 
## public cmd rehash -- stop 

## public cmd relay -- start 
proc pub_relay {nick uhost hand chan rest} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 relay is only available via dcc chat." 
} 
...
global CC 
if {$rest == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}chaninfo <#channel>" 
return 0 
} 
if {[validchan $rest]} { 
set em [lindex [channel info $rest] 0] 
putcmdlog "\002\[LkZ]\002 #$hand# chaninfo $rest" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Settings for static channel $rest" 
set em [lindex [channel info $rest] 0] 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Protect modes (chanmode): $em" 
if {[lindex [channel info $rest] 1] == "0"} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Idle Kick after (idle-kick): DONT!" 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Idle Kick after (idle-kick): [lindex [channel info $rest] 1] min" 
} 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Other modes:" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 [lindex [channel info $rest] 12] [lindex [channel info $rest] 13] [lindex [channel info $rest] 14] [lindex [channel info $rest] 15]" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 [lindex [channel info $rest] 16] [lindex [channel info $rest] 17] [lindex [channel info $rest] 18] [lindex [channel info $rest] 19]" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 [lindex [channel info $rest] 20] [lindex [channel info $rest] 21] [lindex [channel info $rest] 22] [lindex [channel info $rest] 23]" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 [lindex [channel info $rest] 24] [lindex [channel info $rest] 25] [lindex [channel info $rest] 26]" 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 flood settings: chan: $ichan ctcp: $ictcp join: $ijoin kick: $ikick deop: $ideop" 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 No such channel defined." 
} 
} 
...
putcmdlog "\002\[4Y3oan]\002 #$hand# status" 
set vers [lindex $version 0] 
set users [countusers] 
regsub -all " " [channels] ", " chans 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 I am $botnick, running eggdrop v${vers}: $users users" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Running on [exec uname -sr]" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Server $server" 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Online for $output (background) CPU $cpu" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Admin: $admin" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 DCC file path: ${files-path}" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 incoming: ${incoming-path}" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 max users is ${max-file-users}" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 DCC max file size: ${max-filesize}k" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Channels: $chans" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Server $server" 
foreach x [channels] { 
set ch [llength [chanlist $x]] 
set em [lindex [channel info $x] 0] 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $x : $ch members, enforcing \"${em}\"" 
} 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Access denied, people should know who is booting them." 
} 
## public cmd boot -- stop 

## public cmd assoc -- start 
proc pub_assoc {nick uhost hand chan rest} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 assoc is only available via dcc chat." 
} 
## public cmd assoc -- stop 

## public cmd chbotattr -- start 
proc pub_chbotattr {nick uhost hand chan rest} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 See botattr command." 
} 
...
if {$rest == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}unlink <bot>" 
return 0 
} 
if {([validuser $rest] == 0) || ([matchattr $rest b] == 0)} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $rest is not in my userlist as a bot." 
return 0 
} 
if {[lsearch -exact [string tolower [bots]] [string tolower $rest]] == -1} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $rest is not linked on the botnet." 
return 0 
} 
if {[lsearch -exact [string tolower [bots]] [string tolower $rest]] > -1} { 
putcmdlog "\002\[4Y3oan]\002 #$hand# unlink $rest" 
unlink $rest 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Breaking link with $rest" 
} 
} 
...
if {$rest == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}link <bot>" 
return 0 
} 
if {([validuser $rest] == 0) || ([matchattr $rest b] == 0)} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $rest is not in my userlist as a bot." 
...
if {[lsearch -exact [string tolower [bots]] [string tolower $rest]] > -1} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $rest is already linked on the botnet." 
return 0 
} 
if {[lsearch -exact [string tolower [bots]] [string tolower $rest]] == -1} { 
putcmdlog "\002\[4Y3oan]\002 #$hand# link $rest" 
link $rest 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Linking to $rest at [getaddr $rest]" 
} 
} 
## public cmd link -- end 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 su is only available via dcc chat." 
} 
## public cmd strip -- start 
proc pub_strip {nick uhost hand chan rest} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 strip is only available via dcc chat." 
} 
## public cmd strip -- stop 

## public cmd page -- start 
proc pub_page {nick uhost hand chan rest} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 page is only available via dcc chat." 
} 
...
global CC 
if {$rest == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}filestats <handle>" 
return 0 
} 
if {[validuser $rest] == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $rest is not in my userlist." 
return 0 
} 
if {[validuser $rest] == 1} { 
...
putcmdlog "\002\[4Y3oan]\002 #$hand# filestats $rest" 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 \037${rest}'s filestats\037" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 uploads:${main}${nul} /${s}${tul}k" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 downloads:${main}${ndl} /${s}${tdl}k" 
} 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 unstick is only available via dcc chat." 
} 
## public cmd unstick -- stop 

## public cmd stick -- start 
proc pub_stick {nick uhost hand chan rest} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 stick is only available via dcc chat." 
} 
## public cmd stick -- stop 

## public cmd fixcodes -- start 
proc pub_fixcodes {nick uhost hand chan rest} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 fixcodes is only available via dcc chat." 
} 
## public cmd fixcodes -- stop 

## public cmd trace -- start 
proc pub_trace {nick uhost hand chan rest} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 trace is only available via dcc chat." 
} 
## public cmd trace -- stop 

## public cmd botinfo -- start 
proc pub_botinfo {nick uhost hand chan rest} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 botinfo is only available via dcc chat." 
} 
...
global CC botnick 
if {[matchattr $hand Q] == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 This command requires you to authenticate. /msg $botnick auth <password>" 
return 0 
} 
set botname [lindex $rest 0] 
set changes [lindex $rest 1] 
if {($botname == "") || ($changes == "")} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}chaddr <bot> <address:port#\[relay-port#\]>" 
return 0 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 There is no such bot in the userlist." 
return 0 
} 
if {[matchattr $botname b] == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $rest is not a bot." 
return 0 
} 
botattr $botname $changes 
set oldaddy [getuser $botname BOTADDR] 
set oldaddy [lindex $oldaddy 0]:[lindex $oldaddy 1]/[lindex $oldaddy 2] 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Changed ${botname}'s Address from \002\[\002${oldaddy}\002\]\002 to \002\[\002$changes\002\]\002" 
} 
...
set cmdchar $CC 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! rollcall" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 I am ${botnick}, running eggdrop v${botvers}" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 My Command Charactor is \002\[\002${CC}\002\]\002" 
} 
...
if {$who == ""} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: .access <nick | me>" 
return 0 
} 
if {$who == "me"} { 
if {$chan != ""} { 
...
putlog "\002\[4Y3oan]\002 !$hand! access $swho $chan" 
if {$cfflags == "-"} { 
putdcc $idx "\002\[4Y3oan]\002 You do not have any channel specific flags on ${chan}." 
return 0 
} else { 
putdcc $idx "\002\[4Y3oan]\002 Your access is \002\[\002${cfflags}\002\]\002 on ${chan}." 
return 0 
} 
} else { 
putdcc $idx "\002\[4Y3oan]\002 $chan is not a valid channel." 
return 0 
} 
} 
if {$chan == ""} { 
...
putlog "\002\[4Y3oan]\002 !$hand! access $mwho" 
putdcc $idx "\002\[4Y3oan]\002 Your access is \002\[\002${mflags}\002\]\002" 
return 0 
} 
} 
if {[validuser $who] == 1} { 
...
set nflags [string trimleft $cflags "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"] 
set cfflags [string trim $nflags "|"] 
putlog "\002\[4Y3oan]\002 !$hand! access $who $chan" 
if {$cfflags == "-"} { 
putdcc $idx "\002\[4Y3oan]\002 You do not have any channel specific flags on ${chan}." 
return 0 
} else { 
putdcc $idx "\002\[4Y3oan]\002 ${who}'s access is \002\[\002${cfflags}\002\]\002 on ${chan}." 
return 0 
} 
} else { 
putdcc $idx "\002\[4Y3oan]\002 $chan is not a valid channel." 
...
putlog "\002\[4Y3oan]\002 !$hand! access $who" 
putdcc $idx "\002\[4Y3oan]\002 ${who}'s access is \002\[\002${flags}\002\]\002" 
return 0 
} 
} 
if {[validuser $who] == 0} { 
...
set chan [lindex $rest 1] 
if {$who == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}access <nick | me>" 
return 0 
} 
if {$who == "me"} { 
if {$chan != ""} { 
...
putlog "\002\[4Y3oan]\002 !$hand! access $swho $chan" 
if {$cfflags == "-"} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 You do not have any channel specific flags on ${chan}." 
return 0 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Your access is \002\[\002${cfflags}\002\]\002 on ${chan}." 
return 0 
} 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $chan is not a valid channel." 
...
set mflags [chattr $mwho] 
putlog "\002\[4Y3oan]\002 !$hand! access $mwho" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Your access is \002\[\002${mflags}\002\]\002" 
return 0 
} 
} 
if {[validuser $who] == 1} { 
...
putlog "\002\[4Y3oan]\002 !$hand! access $who $chan" 
if {$cfflags == "-"} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 ${who} does not have any channel specific flags on ${chan}." 
return 0 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 ${who}'s access is \002\[\002${cfflags}\002\]\002 on ${chan}." 
return 0 
} 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $chan is not a valid channel." 
...
set flags [chattr $who] 
putlog "\002\[4Y3oan]\002 !$hand! access $who" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 ${who}'s access is \002\[\002${flags}\002\]\002" 
return 0 
} 
} 
if {[validuser $who] == 0} { 
...
set bot [lindex $rest 0] 
if {$bot==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 ${CC}botnick <new botnick>." 
return 0 
} 
putcmdlog "\002\[4Y3oan]\002 #$hand# botnick $bot" 
putserv "NICK $bot" 
} 
...
set bot [lindex $rest 0] 
if {$bot==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 .botnick <new botnick>." 
return 0 
} 
putcmdlog "\002\[4Y3oan]\002 #$hand# botnick $bot" 
putserv "NICK $bot" 
...
if {$server == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: jump <server> \[port\] \[password\]" 
return 0 
} 
set port [lindex $rest 1] 
if {$port == ""} {set port "6667"} 
set password [lindex $rest 2] 
putcmdlog "\002\[4Y3oan]\002 #$hand# jump $server $port $password" 
...
if {$rest == ""} {set rest "Death From AboVe"} 
save 

putcmdlog "\002\[4Y3oan]\002 #$hand# quit $rest" 
if {$rest == ""} {set rest "Death From AboVe"} 
foreach x [userlist] { 
chattr $x -Q 
} 
...
if {$rest == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}ban <nick> \[reason\]" 
return 0 
} 
if {$rest!=""} { 
set handle [lindex $rest 0] 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $handle is not on the channel." 
return 0 
} 
if {[onchansplit $handle $channel]} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $handle is currently net-split." 
return 0 
} 
if {[string tolower $handle] == [string tolower $botnick]} { 
putserv "KICK $channel $nick :\002\[4Y3oan]\002 ..::Thou shalt Never Mess With $botnick with 4Y3oan Power::.." 
return 0 
} 
if {$reason == ""} { 
set reason "Death From AboVe" 
} 
...
if {$reason == ""} {set reason "Death From AboVe"} 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! ban $channel $hostmask $options $reason" 
return 0 
} 
min { 
if {[val [lindex $reason 1]] == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Error, invalid time period" 
return 0 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 I am not oped" 
} 
} 
## public cmd ban -- stop 
...
reload 
putcmdlog "\002\[4Y3oan]\002 #$hand# reload" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Reloading user file..." 
} 
## public cmd restart -- stop 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Currently ignoring:$iglist" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! ignores" 
return 0 
} 
...
if {$hostmask == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}-ignore <hostmask>" 
return 0 
} 
if {[isignore $hostmask] == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $hostmask is not on my ignore list." 
return 0 
} 
if {[isignore $hostmask] == 1} { 
putcmdlog "\002\[4Y3oan]\002 #$hand# -ignore $hostmask" 
killignore $hostmask 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 No longer ignoring \002\[\002${hostmask}\002\]\002" 
save 
} 
} 
...
if {$hostmask == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}+ignore <hostmask> \[comment\]" 
return 0 
} 
if {[isignore $hostmask] == 1} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $hostmask is alreay set on ignore." 
return 0 
} 
if {[isignore $hostmask] == 0} { 
putcmdlog "\002\[4Y3oan]\002 #$hand# +ignore $hostmask" 
newignore $hostmask $nick $comment 0 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Now ignoring \002\[\002${hostmask}\002\]\002" 
save 
} 
} 
## public cmd +ignore -- stop 
...
if {($comment == "")} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}comment <new comment>" 
return 0 
} 
putcmdlog "\002\[4Y3oan]\002 #$hand# comment $comment" 
setuser $hand comment $comment 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Added comment \002\[\002${comment}\002\]\002" 
} 
...
if {($old == "") || ($new == "")} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}chnick <old nick> <new nick>" 
return 0 
} 
if {[validuser $old]==0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 No such user." 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 cannot change the bot owner's nick" 
return 0 
} 
if {[validuser $old]==1} { 
putcmdlog "\002\[4Y3oan]\002 #$hand# chnick $old $new" 
chnick $old $new 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Changed partyline nick from \002\[\002${old}\002\]\002 to \002\[\002${new}\002\]\002" 
} 
} 
...
if {($who == "") || ($info == "")} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}chinfo <nick> <info>" 
return 0 
} 
if {[validuser $who]==0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 No such user." 
...
if {[validuser $who]==1} { 
putcmdlog "\002\[4Y3oan]\002 #$hand# chinfo $who $info" 
setuser $who info $info 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Added info \002\[\002${info}\002\]\002 to $who." 
} 
} 
...
global CC botnick 
if {[matchattr $hand Q] == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 This command requires you to authenticate yourself. Please /msg $botn$ 
return 0 
} 
set who [lindex $rest 0] 
set comment [lrange $rest 1 end] 
if {($who == "") || ($comment == "")} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}chcomment <nick> <new comment>" 
return 0 
} 
if {[validuser $who]==0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 No such user." 
...
if {[validuser $who]==1} { 
putcmdlog "\002\[4Y3oan]\002 #$hand# chcomment $who $comment" 
setuser $who comment $comment 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Added info \002\[\002${comment}\002\]\002 to $who." 
} 
} 
...
proc pub_chemail {nick uhost hand chan rest} { 
global CC botnick 
# puthelp "NOTICE $nick :\002\[4Y3oan]\002 This command is only available via dcc chat" 
# return 0 
if {[matchattr $hand Q] == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 This command requires you to authenticate yourself. Please /msg $botnick auth <password>" 
return 0 
...
if {($who == "") || ($email == "")} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}chemail <nick> <email>" 
return 0 
} 
if {[validuser $who]==0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 No such user." 
...
if {[validuser $who]==1} { 
putcmdlog "\002\[4Y3oan]\002 #$hand# chemail $who $email" 
setuser $who email $email 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Added email address \002\[\002${email}\002\]\002 to $who." 
} 
} 
...
global CC 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Can only be changed via dcc chat." 
} 
...
global CC 
if {$rest == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage ${CC}me <msg>" 
return 0 
} 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! me $rest" 
...
putcmdlog "\002\[4Y3oan]\002 #$hand# save" 
save 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Writing channel & user file ..." 
} 
...
set chan [lindex $rest 2] 
if {$ownern==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}chattr <nick> <flags>" 
return 0 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 You do not have access to change ${ownern}'s flags." 
} 
if {[matchattr $nick n] == 1} { 
if {$chan != ""} { 
if {[validchan $chan]} { 
putcmdlog "\002\[4Y3oan]\002 #$hand# chattr $ownern $flagss $chan" 
...
set chanflags [string trim $chanflags "|"] 
set globalflags [chattr $ownern] 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 chattr $ownern \002\[\002${flagss}\002\]\002 $chan" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Global Flags for $ownern are \002\[\002${globalflags}\002\]\002" 
if {$chanflags != "-"} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Channel \002\"\002${chan}\002\"\002 Flags for $ownern are \002\[\002${chanflags}\002\]\002" 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $ownern does not have any channel specific flags on ${chan}." 
} 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $chan is not a valid channel" 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Chattr $ownern \002\[\002${flagss}\002\]\002" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Global Flags for $ownern are now \002\[\002${flags}\002\]\002" 
} 
...
save 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Writing user file ..." 
} 
...
if {$nflagl != ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 You do not have access to add or remove the flag \002'\002n\002'\002 from that user." 
return 0 
} 
} 
...
if {$nflagl != ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 You do not have access to add or remove the flag \002'\002m\002'\002 from $ownern." 
return 0 
} 
} 
...
if {$chan != ""} { 
if {[validchan $chan]} { 
putcmdlog "\002\[4Y3oan]\002 #$hand# chattr $ownern $flagss" 
if {[string trim $flagss abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ+-] == "|"} { 
chattr $ownern $flagss $chan 
} else { 
chattr $ownern |$flagss $chan 
...
set completed 0 
if {($who == "") || ($hostname == "")} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}-host <nick> <hostmask>" 
return 0 
} 
if {[validuser $who]==0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 No such user." 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Can't remove hostmasks from the bot owner." 
return 0 
} 
if {[matchattr $nick m] == 0} { 
if {[string tolower $hand] != [string tolower $who]} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 You need '+m' to change other users hostmasks" 
return 0 
} 
} 
foreach * [getuser $who HOSTS] { 
if {${hostname} == ${*}} { 
putcmdlog "\002\[4Y3oan]\002 #$hand# -host $who $hostname" 
delhost $who $hostname 
save 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Removed \002\[\002${hostname}\002\]\002 from $who." 
### Make it do the -host thing here, and any message that goes along with it 
set completed 1 
} 
} 
if {$completed == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 No such hostmask!" 
} 
} 
...
set hostname [lindex $rest 1] 
if {($who == "") || ($hostname == "")} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}+host <nick> <new hostmask>" 
return 0 
} 
if {[validuser $who] == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 No such user!" 
...
foreach * [getuser $who HOSTS] { 
if {${hostname} == ${*}} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 That hostmask is already there." 
return 0 
} 
} 
if {($who == "") && ($hostname == "")} { 
...
if {([matchattr $nick n] == 0) && ([matchattr $who n] == 1)} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Can't add hostmasks to the bot owner." 
return 0 
} 
foreach * $thehosts { 
if {${hostname} == ${*}} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Invalid hostmask!" 
set badhost 1 
} 
} 
if {$badhost != 1} { 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Added \002\[\002${hostname}\002\]\002 to $who." 
...
set bot [lindex $rest 0] 
if {$bot==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}-bot <handle>" 
return 0 
} 
if {[validuser $bot] == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $bot is not on my userlist." 
return 0 
} 
if {[matchattr $bot b] == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $bot is not a bot on the userlist." 
return 0 
} 
if {[matchattr $bot b] == 1} { 
putcmdlog "\002\[4Y3oan]\002 #$hand# -bot $bot" 
deluser $bot 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $bot has been deleted from the userlist." 
save 
} 
} 
## public cmd -bot -- stop 
...
if {[validuser $bot]==1} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $bot is already in my userlist." 
return 0 
} 
if {($bot=="") || ($address=="")} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}+bot <botname> <address:botport#\[userport#\]> \[hostmask\]" 
return 0 
} 
...
if {[validuser $bot]==0} { 
putcmdlog "\002\[4Y3oan]\002 #$hand# +bot $bot $address $hostmask" 
addbot $bot $address 
if {$hostmask != ""} { 
setuser $bot HOSTS $hostmask 
} 
save 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $bot \002\[\002${address}\002\]\002 has been add to userlist as a bot." 
return 0 
} 
} 
## public cmd +bot -- stop 
...
if {$rest == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}deluser <handle>" 
return 0 
} else { 
...
set who [lindex $rest 0] 
if {$who == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}-user <nick>" 
} else { 
if {[validuser $who] == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $who is not on my userlist." 
} else { 
if {[matchattr $who n] == 1} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 You cannot delete a bot owner." 
} else { 
if {([matchattr $who m] == 1) && ([matchattr $nick n] == 0)} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 You don't have access to delete $who." 
} else { 
putcmdlog "\002\[4Y3oan]\002 #$hand# -user $who" 
deluser $who 
save 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $who has been deleted." 
} 
} 
} 
} 
...
if {[validuser $who]==1} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $who is already in my userlist." 
return 0 
} 
if {($who=="") || ($hostmask=="")} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}+user <nick> <hostmask>" 
return 0 
} 
set who [lindex $rest 0] 
set flags [lindex $rest 2] 
if {[validuser $who]==0} { 
putcmdlog "\002\[4Y3oan]\002 #$hand# +user $who $hostmask" 
adduser $who $hostmask 
save 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $who has been added to userlist with hostmask \002\[\002$hostmask\002\]\002." 
if {$flags != ""} { 
chattr $who $flags $channel 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Added $flags to $who" 
} 
return 0 
} 
} 
...
if {[lindex $rest 0] == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}adduser <nick> \[optional flags\]" 
return 0 
} 
if {[validuser [lindex $rest 0]]} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $rest is already in my userlist." 
return 0 
} 
...
putcmdlog "\002\[4Y3oan]\002 #$hand# adduser $who $oflags" 
adduser $who $host 
if {$oflags != ""} { 
if {[lindex $rest 2] != ""} { 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $who \002\[\002$newhost\002\]\002 has been added to the userlist." 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Global Flags for $who are \002\[\002${flags}\002\]\002" 
set chanflags [chattr [lindex $rest 0] | [lindex $rest 2]] 
set chanflags [string trimleft $chanflags "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"] 
set chanflags [string trim $chanflags |] 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Channel \002\"\002[lindex $rest 2]\002\"\002 Flags for $who are \002\[\002${chanflags}\002\]\002" 
save 
return 0 
} else { 
chattr $who $oflags 
...
set flags [chattr $who] 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $who \002\[\002$host\002\]\002 has been added to the userlist." 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Global Flags for $who are \002\[\002${flags}\002\]\002" 
save 
return 0 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 That user is not on $channel." 
} 
} 
...
if {$rest==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: part <#channel>" 
return 0 
} else { 
foreach x [channels] { 
if {[string tolower $x]==[string tolower $rest]} { 
if {[string tolower $rest]==[string tolower $nopart]} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Sorry I can not part $nopart \[PROTECTED\]" 
return 0 
} 
channel remove $rest 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 I have left $x" 
putcmdlog "\002\[4Y3oan]\002 #$hand# part $x" 
return 0 
} 
} 
} 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 I wasn't in $rest" 
} 
...
if {$chan=="#"} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}join <#channel>" 
} else { 
foreach x [channels] { 
if {[string tolower $x]==[string tolower $chan]} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Your already in $x" 
return 0 
} 
} 
if {[lindex $rest 1] == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 I have joined $chan" 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 I have joined $chan (key: [lindex $rest 1])" 
} 
channel add $chan 
if {$rest!=""} { 
putserv "JOIN $chan :[lindex $rest 1]" 
putcmdlog "\002\[4Y3oan]\002 #$hand# join $chan (key: [lindex $rest 1])" 
} 
} 
} 
...
if {$chan=="#"} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: join <#channel> \[key\]" 
} else { 
foreach x [channels] { 
if {[string tolower $x]==[string tolower $chan]} { 
putdcc $idx "\002\[4Y3oan]\002 Your already in $x" 
return 0 
} 
} 
if {[lindex $rest 1] == ""} { 
putdcc $idx "\002\[4Y3oan]\002 I have joined $chan" 
} else { 
putdcc $idx "\002\[4Y3oan]\002 I have joined $chan (key: [lindex $rest 1])" 
} 
channel add $chan 
if {$rest!=""} { 
putserv "JOIN $chan :[lindex $rest 1]" 
...
if {$rest==""} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: part <#channel>" 
return 0 
} else { 
foreach x [channels] { 
if {[string tolower $x]==[string tolower $rest]} { 
if {[string tolower $rest]==[string tolower $nopart]} { 
putdcc $idx "\002\[4Y3oan]\002 Sorry I can not part $nopart \[PROTECTED\]" 
return 0 
} 
channel remove $rest 
putdcc $idx "\002\[4Y3oan]\002 I have left $x" 
putcmdlog "\002\[4Y3oan]\002 #$hand# part $x" 
return 0 
} 
} 
} 
putdcc $idx "\002\[4Y3oan]\002 I wasn't in $rest" 
} 
## dcc cmd part -- stop 
...
if {$rest==""} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: say <msg>" 
} 
if {$rest!=""} { 
set chan2send [lindex [console $idx] 0] 
puthelp "PRIVMSG $chan2send :$rest" 
putcmdlog "\002\[4Y3oan]\002 #$hand# say $rest" 
} 
} 
## dcc cmd say -- stop 
...
if {$rest==""} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: act <msg>" 
} 
if {$rest!=""} { 
set chan2send [lindex [console $idx] 0] 
putserv "PRIVMSG $chan2send :\001ACTION $rest\001" 
putcmdlog "\002\[4Y3oan]\002 #$hand# act $rest" 
} 
} 
## dcc cmd act -- stop 
...
if {$rest==""} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: addlog <log>" 
} else { 
putcmdlog "\002\[4Y3oan]\002 $hand: $rest" 
} 
} 
## dcc cmd addlog -- stop 
...
if {$rest==""} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: invite <nick>" 
return 0 
} else { 
if {[onchan $rest $activechan]==1} { 
putdcc $idx "\002\[4Y3oan]\002 $rest is on $activechan already!" 
return 0 
} else { 
putserv "INVITE $rest :$activechan" 
putdcc $idx "\002\[4Y3oan]\002 Invitation sent to $rest" 
putcmdlog "\002\[4Y3oan]\002 #$hand# invite $rest" 
} 
} 
} 
...
if {[botisop $channel]!=1} { 
if {$botnick!=$nick} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Are u crazy??? ... did u see iam not better than ur status ..HAHAHAHAHA..lol" 
} 
} 
} 
## cmd aop join -- stop 
...
chattr $who |-a $chan 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $who is no longer auto oped on $chan" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! raop $who $chan" 
return 0 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $who wasn't auto oped on $chan" 
return 0 
} 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $chan is not a valid channel" 
...
if {[matchattr $who a] == 1} { 
chattr $who -a 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $who is no longer a global auto oped" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! raop $who $chan" 
return 0 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $who wasn't auto oped" 
return 0 
} 
} 
} 
if {[validuser $who] == 0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $who is not a valid user" 
} 
} 
if {$who == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: raop <nick>" 
} 
} 
## dcc cmd raop -- stop 
...
chattr $who |a $chan 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $who is now auto oped on $chan" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! aop $who $chan" 
return 0 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $who is already auto oped on $chan" 
return 0 
} 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $chan is not a valid channel" 
...
chattr $who +a 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $who is now global auto oped." 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! aop $who" 
return 0 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $who is already auto oped" 
return 0 
} 
} 
} 
...
if {$who == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}aop <nick>" 
} 
} 
## public cmd aop -- stop 
...
if {[matchattr $who |a $chan] == 0} { 
chattr $who |a $chan 
putdcc $idx "\002\[4Y3oan]\002 $who is now auto oped on $chan" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! aop $who $chan" 
return 0 
} else { 
putdcc $idx "\002\[4Y3oan]\002 $who is already auto oped on $chan" 
return 0 
} 
} else { 
putdcc $idx "\002\[4Y3oan]\002 $chan is not a valid channel" 
...
if {[matchattr $who a] == 0} { 
chattr $who +a 
putdcc $idx "\002\[4Y3oan]\002 $who is now global auto oped." 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! aop $who" 
return 0 
} else { 
putdcc $idx "\002\[4Y3oan]\002 $who is already auto oped" 
return 0 
} 
} 
} 
if {[validuser $who] == 0} { 
putdcc $idx "\002\[4Y3oan]\002 $who is not a valid user" 
} 
} 
if {$who == ""} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: aop <nick>" 
} 
} 
## dcc cmd aop -- stop 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Channel:$chanlisting" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! channel" 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 People$peoplenum:$peoplelist" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Bots$botnum:$botlist" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! who" 
return 0 
} 
## public cmd who -- stop 
...
global botnick max-notes 
set fl "\002\[4Y3oan]\002" 
if {[validuser $rest] == 0} { 
putserv "NOTICE $nick :\002\[4Y3oan]\002 No such user!" 
return 0 
} 
set user [lindex $rest 0] 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 People:$peoplelist" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! whom" 
return 0 
} 
...
global CC 
if {$rest==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}match <flags>" 
return 0 
} 
set rest [string trim $rest +] 
if {[string length $rest] > 1} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Invalid option." 
return 0 
} 
if {$rest!=""} { 
set rest "+[lindex $rest 0]" 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Match \[$rest\]: $users" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! match $rest" 
return 0 
} 
if {[userlist $rest]==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 No users with flags \[$rest\]" 
return 0 
} 
} 
} 
...
if {$flags==""} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: match <flags>" 
return 0 
} 
if {[string length $flags] > 1} { 
putdcc $idx "\002\[4Y3oan]\002 Invalid Option." 
return 0 
} 
if {$flags!=""} { 
if {[userlist $flags]!=""} { 
regsub -all " " [userlist $flags] ", " users 
putdcc $idx "\002\[4Y3oan]\002 Match \[$flags\]: $users" 
putlog "\002\[4Y3oan]\002 #$hand# match $flags" 
return 0 
} 
if {[userlist $flags]==""} { 
putdcc $idx "\002\[4Y3oan]\002 No users with flags \[$flags\]" 
return 0 
} 
} 
} 
...
if {[bots]==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 No bots connected" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! bots" 
return 0 
} 
if {[bots]!=""} { 
regsub -all " " [bots] ", " bots 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Bots: $bots" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! bots" 
return 0 
} 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Bottree is only available via dcc chat, try Bots" 
} 
## public cmd bottree - stop 

## public cmd notes -- start 
proc pub_notes {nick uhost hand chan rest} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 notes is only available via dcc chat" 
} 
...
if {[botisop $channel]==1} { 
if {$rest == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}+ban <hostmask> \[reason\]" 
return 0 
} 
if {$rest!=""} { 
...
putserv "KICK $channel $nick :\002\[4Y3oan]\002 -Thou shalt Never Mess With $botnick with aYc Power-Let's Play with my ass" 
return 0 
} 
if {$reason == ""} { 
set reason "\002Ban enforcing - Yoan\002" 
} 
set options [lindex $reason 0] 
if {[string index $options 0] == "-"} { 
set options [string range $options 1 end] 
...
if {$reason == ""} {set reason "Death From AboVe"} 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! +ban $reason" 
return 0 
} 
min { 
if {[val [lindex $reason 1]] == ""} { 
...
if {[botisop $channel]==1} { 
if {$rest==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: -ban <ban #>" 
} 
if {$rest!=""} { 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 No such channel ban. It may be a global ban" 
return 0 
} 
if {[lindex [banlist $channel] [expr ${rest}-1]]!=""} { 
set restban [lindex [lindex [banlist $channel] 0] [expr ${rest}-1]] 
killchanban $channel $rest 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Ban $restban was removed" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! -ban $rest" 
return 0 
} 
} 
} 
...
if {$rest!="CHANNEL"} { 
if {$rest!="GLOBAL"} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: bans <global | channel>" 
} 
} 
set banlistchan "" 
if {$rest=="CHANNEL"} { 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Channel Bans:$banlistchan" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! bans channel" 
return 0 
} 
set banlist "" 
if {$rest=="GLOBAL"} { 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Global Bans:$banlist" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! bans global" 
return 0 
} 
} 
...
if {[botisop $channel]==1} { 
if {$rest==""} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: op <nick>" 
} 
if {[onchan $rest $channel]=="1"} { 
if {[isop $rest $channel]=="1"} { 
putdcc $idx "\002\[4Y3oan]\002 $rest is already oped" 
} 
} 
if {$rest!=""} { 
if {[onchan $rest $channel]=="0"} { 
putdcc $idx "\002\[4Y3oan]\002 $rest isn't on the channel" 
} 
} 
if {[onchan $rest $channel]=="1"} { 
if {[isop $rest $channel]=="0"} { 
pushmode $channel +o $rest 
putlog "\002\[4Y3oan]\002 #$hand# op $rest" 
} 
} 
} 
if {[botisop $channel]!=1} { 
putdcc $idx "\002\[4Y3oan]\002 I am not oped, sorry." 
} 
} 
## dcc cmd op -- stop 
...
if {[onchan $rest $channel]==1} { 
if {[isop $rest $channel]==1} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $rest is already oped." 
} 
} 
if {$rest!=""} { 
if {[onchan $rest $channel]==0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $rest isn't on the channel." 
} 
} 
if {[onchan $rest $channel]==1} { 
if {[isop $rest $channel]==0} { 
pushmode $channel +o $rest 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! op $rest" 
} 
} 
} 
if {[botisop $channel]!=1} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 I am not oped, sorry." 
} 
} 
## public cmd op -- stop 
...
if {[botisop $channel]==1} { 
if {$rest==""} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: deop <nick>" 
} 
if {$rest!=""} { 
if {[onchan $rest $channel]=="0"} { 
putdcc $idx "\002\[4Y3oan]\002 $rest isn't on the channel" 
...
if {[onchan $rest $channel]=="1"} { 
if {[isop $rest $channel]=="0"} { 
putdcc $idx "\002\[4Y3oan]\002 $rest is already deoped" 
} 
} 
if {[string tolower $botnick] == [string tolower $rest]} { 
putdcc $idx "\002\[4Y3oan]\002 I don't deop myself..." 
} 
if {[isop $rest $channel]=="1"} { 
if {[onchan $rest $channel]=="1"} { 
if {$botnick!=$rest} { 
pushmode $channel -o $rest 
putlog "\002\[4Y3oan]\002 #$hand# deop $rest" 
} 
} 
} 
} 
if {[botisop $channel]!=1} { 
putdcc $idx "\002\[4Y3oan]\002 I am not oped" 
} 
} 
## dcc cmd deop -- stop 
...
if {[onchan $rest $channel]=="1"} { 
if {[isop $rest $channel]=="0"} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $rest is already deoped." 
return 0 
} 
} 
if {[string tolower $botnick] == [string tolower $rest]} { 
putserv "KICK $channel $nick :Thou shalt Never Mess With $botnick with 4Y3oan Power Wanna see my cook?? :P~~" 
return 0 
} 
if {[isop $rest $channel]=="1"} { 
if {[onchan $rest $channel]=="1"} { 
if {[string tolower $botnick] != [string tolower $rest]} { 
pushmode $channel -o $rest 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! deop $rest" 
} 
} 
} 
} 
...
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! topic $rest" 
} else { 
...
if {$rest==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: topic <topic>" 
} 
} 
...
if {$rest!=""} { 
putserv "PRIVMSG $channel :\001ACTION $rest\001" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! act $rest" 
return 0 
} 
if {$rest==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: act <msg>" 
} 
} 
## public cmd act -- stop 
...
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! say $rest" 
return 0 
} 
if {$rest==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: say <msg>" 
} 
} 
## public cmd say -- stop 
...
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! msg $rest" 
return 0 
} 
if {$rest==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: msg <nick> <msg>" 
} 
} 
## public cmd msg -- stop 

## public cmd tsunami -- start 
proc pub_tsunami {nick uhost hand channel rest} { 
set person [lindex $rest 0] 
set rest [lrange $rest 1 end] 
if {$rest!=""} { 
puthelp "PRIVMSG $person :$rest ,|12,7HueueuHehe@#$%||@#$%||@#$%||@#$%||@#$%||@#$%|||4Y3oan!!|@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||||4Y3oan!!@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||4Y3oan!!" 
puthelp "NOTICE $person :$rest ,|12,7HueueuHehe@#$%||@#$%||@#$%||@#$%||@#$%||@#$%|||4Y3oan|@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||||4Y3oan!!@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||4Y3oan!!" 
puthelp "PRIVMSG $person :$rest ,|12,7HueueuHehe@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||||4Y3oan!!@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||||4Y3oan!!@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||4Y3oan!!" 
puthelp "NOTICE $person :$rest ,|12,7HueueuHehe@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||||4Y3oan!!@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||||4Y3oan!!@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||4Y3oan!!" 
puthelp "PRIVMSG $person :$rest ,|12,7HueueuHehe@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||||4Y3oan!!@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||||4Y3oan!!@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||4Y3oan!!" 
puthelp "NOTICE $person :$rest ,|12,7HueueuHehe@#$%||@#$%||@#$%||@#$%||@#$%||@#$%|||4Y3oan!!@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||||4Y3oan!!@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||@#$%||4Y3oan!!" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! tsunami $person" 
return 0 
} 
if {$rest==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: tsunami <nick> <*add your insult to injury is better :)*>" 
} 
} 
## public cmd tsunami -- stop 

## public cmd kill -- start 
...
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! kill $person" 
return 0 
} 
if {$rest!=""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: kill <nick>" 
} 
} 
## public cmd msg -- stop 
...
putserv "NOTICE $nick :I am $botnick, running v[lindex $version 0] with Yoan.tcl v${vers}" 
puts $new "I am $botnick, running v[lindex $version 0] with Yoan.tcl v${vers}" 
...
if {$rest==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: addlog <msg>" 
} 
if {$rest!=""} { 
putlog "\002\[4Y3oan]\002 $hand: $rest" 
} 
} 
...
set rest [lindex $rest 0] 
if {$rest==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: invite <nick>" 
} 
if {$rest!=""} { 
if {[onchan $rest $chan]==0} { 
putserv "INVITE $rest :$chan" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Invitation to $chan has been sent to $rest" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! invite $rest" 
return 0 
} 
if {[onchan $rest $chan]==1} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $rest is already on the channel" 
} 
} 
} 
## public cmd invite -- stop 
...
set rest [lindex $rest 0] 
if {$rest==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: nick <new nick on bot>" 
} 
if {$rest!=""} { 
chnick $hand $rest 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Your partyline handle is now [nick2hand $nick $chan]" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! nick $rest" 
return 0 
} 
} 
...
## Away stuff ## 
set idle.v "\002\[4Y3oan]\002-AnTiiDLE TecHNoLoGy" 
set idle.1 10 
#make a private msg to someone, or your home channel 
set idle.w "$botnick" 
set idle.m "\002\[4Y3oan]\002 rules :) ..:: LoaDeD with $vers ::.." 
...
set awaym { 
"(Making Little Yoan) \[4Y3oan-MsgLog On\]"
"(Making Love) \[4Y3oan-MsgLog On\]"
"(Cari Sembako) \[4Y3oan-MsgLog On\]"
"(Beli Beras) \[4Y3oan-MsgLog On\]"
"(Kegusur User) \[4Y3oan-MsgLog On\]"
"(Merindukan Kekasih Tercinta) \[4Y3oan-MsgLog On\]"
"(Kencan Dulu Ahh...) \[4Y3oan-MsgLog On\]"
"(Kamu Dituduh Pencuri...!!) \[4Y3oan-MsgLog On\]"
"(Modiar) \[4Y3oan-MsgLog On\]"
"(Cari Pecun) \[4Y3oan-MsgLog On\]"
"(Yoan Ganteng) \[4Y3oan-MsgLog On\]"
"(Lagi Horny Nich !!) \[4Y3oan-MsgLog On\]"
"(Mojok Dulu) \[4Y3oan-MsgLog On\]"
"(Ke Warnet Indonet Two) \[4Y3oan-MsgLog On\]"
"(Jual Diri) \[4Y3oan-MsgLog On\]"
"(LOve is SucK) \[4Y3oan-MsgLog On\]"
"(Bokep Time !!!) \[4Y3oan-MsgLog On\]"
"(Baca Hentai) \[4Y3oan-MsgLog On\]"
"(Cari pass XXX) \[4Y3oan-MsgLog On\]"
"(Pergi Ke Dolly Dulu) \[4Y3oan-MsgLog On\]"
"(ML Yuk...!!!) \[4Y3oan-MsgLog On\]"
"(Yoannnnnn!!) \[4Y3oan-MsgLog On\]" 
"(BoBo NyeNyakZ!!) \[4Y3oan-MsgLog On\]" 
"(Lage Chat Ma Awinz) \[4Y3oan-MsgLog On\]" 
"(Budi Emang DoDoL) \[4Y3oan-MsgLog On\]" 
"(BeOlz BenTaRz) \[4Y3oan-MsgLog On\]" 
"(NyariIn Om Yoan) \[4Y3oan-MsgLog On\]" 
"(Yoan LoVe Awinz) \[4Y3oan-MsgLog On\]" 
"(Kata Yoan Belajar...) \[4Y3oan-MsgLog On\]" 
"(BeLajaR BiKinz AdiKz) \[4Y3oan-MsgLog On\]" 
"(LaGi NontOnz BokeP) \[4Y3oan-MsgLog On\]" 
"(Ooh Yoan Lage Jatuh Cinta) \[4Y3oan-MsgLog On\]" 
"(Awinz Mana Yah...) \[4Y3oan-MsgLog On\]" 
"(Be Er Be Lagi Be oLz) \[4Y3oan-MsgLog On\]" 
"(Merindukan Awinz Tercinta) \[4Y3oan-MsgLog On\]" 
"(Mojok Ama Awinz) \[4Y3oan-MsgLog On\]" 
"(Sedih Ditinggal Ma Awinz...) \[4Y3oan-MsgLog On\]" 
"(Nunggu Awinz On-Line...) \[4Y3oan-MsgLog On\]" 
"(Blajar Mazakz Ma Awinz...) \[4Y3oan-MsgLog On\]" 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Chat is only available via dcc chat" 
} 
...
set rest [lrange $rest 1 end] 
if {$rest==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: note <hand> <note>" 
} 
if {$rest!=""} { 
set notetest [sendnote $hand $reciever $rest] 
if {$notetest==1} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Note to $reciever was recieved" 
} 
if {$notetest==2} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Note to $reciever was stored \[local\]" 
} 
if {$notetest==3} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 ${reciever}'s mailbox was full" 
} 
if {$notetest==4} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Tcl binding intercepted the note" 
} 
if {$notetest==5} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $reciever was away, note stored" 
} 
if {$notetest==0} { 
puthelp "NOTICE $nick :Send to $reciever failed" 
return 0 
} 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! note $reciever *masked*" 
} 
} 
## public cmd chat -- stop 
...
if {$wowfiles!=""} { 
set z 0 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $botnick is offering \002[llength $wowfiles] packs\002, type \002.get \[X\]\002 to recieve a file" 
foreach x $wowfiles { 
set z [expr $z+1] 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 $z\002)\002 $wowfiles" 
} 
} 
if {$wowfiles==""} {set wowfiles "No files available"} 
if {$wowdirs==""} {set wowdirs "No directories available"} 
if {$wowfiles=="No files available"} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Files: $wowfiles" 
} 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Directories: $wowdirs" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Many more commands available via dcc chat" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! files" 
return 0 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Newpass: For some reason, I think not" 
} 
## public cmd newpass -- stop 

## public cmd console -- start 
proc pub_console {nick uhost hand chan rest} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Console is only available via dcc chat" 
} 
...
global server 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Server: Current Server is $server" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! servers" 
return 0 
} 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 quit is only available via dcc chat." 
} 
...
if {$rest==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}k <nick> \[reason\]" 
} 
if {$rest!=""} { 
...
if {[botisop $channel]==1} { 
if {$rest == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: kick <nick> \[reason\]" 
return 0 
} 
set handle [lindex $rest 0] 
set reason [lrange $rest 1 end] 
...
if {$reason == ""} { 
set reason "3グ4Y3oan갱 Death From AboVe by 3グ4Y3oan갱" 
} 
if {[string tolower $handle] == [string tolower $botnick]} { 
putserv "KICK $channel $nick :Thou shalt Never Mess With $botnick with 4Y3oan Power Wanna try my wife?? FUCK OFF!" 
return 0 
} else { 
if {[matchattr $handle n] == 1} { 
putserv "KICK $channel $nick :..::Thou shalt Never Mess With my owner::.." 
return 0 
} else { 
putserv "KICK $channel $handle : 3グ4Y3oan갱 $reason 3グ4Y3oan갱" 
if {$reason == ""} {set reason "Death From AboVe"} 
putcmdlog "\002\[4Y3oan]\002 #$hand# kick $handle $reason" 
return 0 
} 
} 
} 
if {[botisop $channel]==0} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 sorry euy aing mah lain OP :P~" 
} 
} 
## dcc cmd kick -- stop 
...
if {$args == ""} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: mdeop <#channel>" 
} 
if {$args != ""} { 
...
set args [lindex $arg 0] 
if {$args == ""} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: mop <#channel>" 
} 
if {$args != ""} { 
...
putserv "MODE $chan -oooooo $deopnicks" 
putlog "\002\[4Y3oan]\002 #$hand# massdeop" 
} 
} 
...
pushmode $chan +oooooo $opnicks 
putlog "\002\[4Y3oan]\002 #$hand# massop" 
} 
} 
...
if {$chan == ""} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: massdeop <#channel>" 
return 1 
} 
if {$mass==1} { 
set deopnicks "" 
...
set chan [lindex $arg 0] 
if {$chan == ""} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: massop <#channel>" 
return 1 
} 
if {$mass == 1} { 
set opnicks "" 
...
if {[botisop $channel]==1} { 
if {$rest == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}kickban <nick> \[reason\]" 
return 0 
} 
if {$rest!=""} { 
set handle [lindex $rest 0] 
...
if {[string tolower $handle] == [string tolower $botnick]} { 
putserv "KICK $channel $nick :\002\3グ4Y3oan갱\002 Thou shalt Never Mess With $botnick with 4Y3oan.." 
return 0 
} 
if {$reason == ""} { 
set reason "Death From AboVe" 
...
newchanban $channel $hostmask $nick "$reason" 0 
if {$reason == ""} {set reason "Death From AboVe"} 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! kicban $channel $hostmask $options $reason" 
putserv "KICK $channel $handle :\3グ4Y3oan갱\ $reason 3グ4Y3oan갱" 
return 0 
} 
min { 
...
if {[isop $botnick $channel]!=1} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Yee daku lum OP nich" 
} 
} 
...
if {[botisop $channel]==1} { 
if {$rest == ""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: ${CC}kb <nick> \[reason\]" 
return 0 
} 
if {$rest!=""} { 
set handle [lindex $rest 0] 
...
if {[string tolower $handle] == [string tolower $botnick]} { 
putserv "KICK $channel $nick :\002\[4Y3oan]\002 You really shouldn't try that..." 
return 0 
} 
if {$reason == ""} { 
set reason "Death From AboVe" 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Info: $wowthatinfo" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! info" 
return 0 
} 
if {$rest!=""} { 
if {[string toupper $rest]=="NONE"} { 
setuser $hand info "" 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Your info has been cleared" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! info none" 
return 0 
} 
if {[string toupper $rest]!="NONE"} { 
setuser $hand info $rest 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Your info is now $rest" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! info $rest" 
return 0 
} 
} 
} 
...
set rest [lindex $rest 0] 
if {$rest==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: get <file #>" 
} 
if {$rest!=""} { 
set f 0 
...
if {$f==1} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Sending you [lrange [getfiles /] $numberoffile $numberoffile]" 
dccsend dcc/[lrange [getfiles /] $numberoffile $numberoffile] $nick 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! get $rest" 
return 0 
} 
if {$f!="1"} { 
puhelp "NOTICE $nick :\002\[4Y3oan]\002 Incorrect file number" 
} 
} 
} 
## public cmd get -- stop 
...
set f [lindex $args 0] 
if {[userlist $f] ==""} { 
putdcc $idx "\002\[4Y3oan]\002 No users with flag(s) $f." 
putcmdlog "\002\[4Y3oan]\002 #$hand# userlist $f" 
return 0 
} 
if {[userlist $f] !=""} { 
regsub -all " " [userlist $f] ", " userlist 
putdcc $idx "\002\[4Y3oan]\002 Userlist: $userlist" 
putcmdlog "\002\[4Y3oan]\002 #$hand# userlist $f" 
return 0 
} 
} 
...
set f [lindex $rest 0] 
if {[userlist $f] ==""} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 No users with flag(s) \[$f\]" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! userlist $f" 
} 
if {[userlist $f] !=""} { 
set tester $f 
if {$tester!=""} {set tester " \[$tester\]"} 
regsub -all " " [userlist $f] ", " userlist 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Userlist$tester: $userlist" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! userlist $f" 
} 
} 
...
putdcc $idx "7"4째4Y3oan4째7" Enjoy! 7"4째4Y3oan4째7"" 
putcmdlog "\002\[4Y3oan]\002 #$hand# ramen" 
return 0 
} 
## dcc cmd ramen -- stop 
...
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! pez" 
return 0 
} 
...
puthelp "PRIVMSG $chan :ENJOY!" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! ramen" 
return 0 
} 
...
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! ping" 
} 
...
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! pong" 
} 
## public cmd pong -- stop 

## dcc cmd channels -- start 
proc cmd_channels {hand idx args} { 
putdcc $idx "\002\[4Y3oan]\002 Channels: [channels]" 
putcmdlog "\002\[4Y3oan]\002 #$hand# channels" 
} 
...
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! beer" 
return 0 
} 
switch $rest { 
sixpack { putserv "PRIVMSG $chan :Here's some sixpacks, it's on me... =]" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! beer $rest" 
return 0 } 
...
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! beer $rest" 
return 0 } 
help { putserv "NOTICE $nick :\002\[4Y3oan]\002 Beer Help" 
putserv "NOTICE $nick :\002\[4Y3oan]\002 Usage: beer <command>" 
putserv "NOTICE $nick :\002\[4Y3oan]\002 Usable Beer Types Are:" 
putserv "NOTICE $nick :\002\[4Y3oan]\002 Sixpack, Keg, Mug, Can, Tap, Time" 
putserv "NOTICE $nick :\002\[4Y3oan]\002 End Of Help -" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! beer $rest" 
return 0 } 
return 0 
} 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: beer <help | command>'" 
} 
...
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! drug" 
return 0 
} 
switch $rest { 
weed { putserv "PRIVMSG $chan :Here's some weed, now pack a bong =]" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! drug $rest" 
return 0 } 
...
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! drug $rest" 
return 0 } 
help { putserv "NOTICE $nick :\002\[4Y3oan]\002 Drug Help" 
putserv "NOTICE $nick :\002\[4Y3oan]\002 Usage: drug <cmd>" 
putserv "NOTICE $nick :\002\[4Y3oan]\002 Usable Drug Types Are:" 
putserv "NOTICE $nick :\002\[4Y3oan]\002 Weed, Bud, Shrooms, Acid, Opium, " 
putserv "NOTICE $nick :\002\[4Y3oan]\002 Extasy, Time" 
putserv "NOTICE $nick :\002\[4Y3oan]\002 End Of Help -" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! drug $rest" 
return 0 } 
...
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Usage: drug <help | command>" 
} 
...
putcmdlog "\002\[4Y3oan]\002 #$hand# global $gsay" 
} 
if {$gsay==""} { 
putdcc $idx "\002\[4Y3oan]\002 Usage: global <msg>" 
} 
} 
## dcc global -- stop 
...
putdcc $idx "\002\[4Y3oan]\002 Usage: flagnote <flag> <msg>" 
return 0 
} 
...
putdcc $idx "\002\[4Y3oan]\002 The flag $boldwhichflag is for bots only" 
putdcc $idx "\002\[4Y3oan]\002 Choose from the following: $oldflags $newflags" 
return 0 
} 
if {([lsearch -exact $oldflags $normwhichflag] < 0) && ([lsearch -exact $botflags $normwhichflag] < 0)} { 
putdcc $idx "\002\[4Y3oan]\002 The flag $boldwhichflag is not a defined flag" 
putdcc $idx "\002\[4Y3oan]\002 Choose from the following: $oldflags" 
return 0 
} 
putlog "\002\[4Y3oan]\002 #$hand# flagnote [string tolower \[+$whichflag\]]" 
putdcc $idx "\002\[4Y3oan]\002 Sending FlagNote to all $boldwhichflag users" 
...
if {$fronttime == "00"} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 The current time is 12$backtime AM $timezone" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! time" 
return 0 
} 
if {$fronttime < 12} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 The current time is $fronttime$backtime AM $timezone" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! time" 
return 0 
} 
if {$fronttime >= 12} { 
putserv "NOTICE $nick :\002\[4Y3oan]\002 The current time is [expr $fronttime-12]$backtime PM $timezone" 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! time" 
return 0 
} 
} 
...
if {[botisop $channel] != 1} { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 Im not oped, sorry." 
return 0 
} 
if {[isop $nick $channel] == 1} { 
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! down" 
pushmode $channel -o $nick 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 You are already deoped." 
return 0 
} 
} 
...
putlog "\002\[4Y3oan]\002 <<$nick>> !$hand! up" 
pushmode $channel +o $nick 
} else { 
puthelp "NOTICE $nick :\002\[4Y3oan]\002 You are already oped." 
return 0 
} 
} 
## public cmd up -- stop 
################################################################## 
#this bit is used when the nickserv is sending the kill message. # 
#This will make the bot to auto-ident itself whenever it receives# 
#warning notice from nickserv. This will prevent the bot's nick  # 
#To be changed to GuestXXXXX nick. (Use in DALnet only)          # 
#By Yoan if you play in dalnet,just uncomment the lines below    # 
################################################################## 
#Modify this to whatever pass your bot is. 
#better put set nickpass in your config file , it's easier to remember 
#because if your bots use same pass, and it gets hacked, YOU are FUCKED :) 
set nickpass "timing123" 

#Don't modify anything below here, 
#Unless you know what you are doing :P 

bind notc - "*You have * comply before*" auto_ident 

proc auto_ident {nick uhost hand text} { 
global nickpass botnick 
if {![string match *service@dal.net * $uhost]} { 
putlog "\002\[4Y3oan]\002 ..::The Kill Message is Fake!...Halting::.." 
return 0 
} 
if {$nickpass == ""} { 
putlog "Error: No pass defined" 
return 0 
} else { 
puthelp "PRIVMSG NickServ :identify $botnick $nickpass" 
putlog "\002\[4Y3oan]\002 ..::Identifying to NickServ to prevent kill::.." 
return 1 
} 
} 
########################## 
#End of dalnet anti kill # 
########################## 
putlog "Yoan" 
putlog "Yoan.tcl By Yoan (r) is Succesfully LoaDeD..." 


################################# 
## What are the words to trigger? 
## add your triggers to the list BandNicks as below: 
set BandNicks { "*fuck*" 
"*bitch*" 
"*asshole*" 
"*kontol*" 
...
################################# 
## What channel to activate on? 
## If all channels is desired then se it to "" 
## Other, you may add it to the list BandWordChan as below: 
set BandNickChan "" 
...
if {!$temp} { return } 
if {([ matchattr $hand n])} { 
putserv "PRIVMSG $chan :\001ACTION didn't see BADNICK@$uhost walking into $chan \[:-)\001" 
return 1 
} elseif {[matchattr $hand 4]} { 
putserv "PRIVMSG $chan :$uhost: Change Your Nick!!!!" 
set BadReason "$ZBan I insist" 
newchanban $chan [maskhost $uhost] $botnick $BadReason perm 
chattr $hand +k4 
return 1 
} else { 
adduser $nick [maskhost [getchanhost $nick $chan]] 
chattr $hand +4 
putserv "PRIVMSG $chan :\001ACTION Detecting badnick/ident at $uhost\001" 
set BadReason "$ZBan $uhost" 
putserv "KICK $chan $nick :$ZBan Change Your Nick!!!" 
newchanban $chan [maskhost $uhost] $botnick $BadReason 60 
putserv "PRIVMSG $nick :\001ACTION Change Your Nick!!!\001" 
return 0 
} 
} 
} 

putlog "\[Nick|Kick\] v4.0 by 4Y3oan is Loaded
" 
...
bind pub - "*fuck*" badword 
bind pubm - "*asshole*" badword 
bind pub - "*asshole*" badword 
bind pubm - "*bitch*" badword 
bind pub - "*bitch*" badword 
bind pubm - "slut" badword 
bind pub - "slut" badword 
bind pubm - "*kontol*" badword 
bind pub - "*kontol*" badword 
bind pubm - "f.u.c.k" badword 
bind pub - "f.u.c.k" badword 
bind pubm - "*suck*" badword 
bind pub - "*suck*" badword 
bind pubm - "*f_u_c_k*" badword 
bind pub - "*f-u-c-k*" badword 
bind pubm - "b-i-t-c-h" badword 
bind pubm - "b.i.t.c.h" badword 
bind pubm - "b_i_t_c_h" badword 
bind pub - "b-i-t-c-h" badword 
bind pub - "b.i.t.c.h" badword 
bind pub - "b_i_t_c_h" badword 
bind pubm - "a.s.s.h.o.l.e" badword 
bind pubm - "a_s_s_h_o_l_e" badword 
bind pub - "a.s.s.h.o.l.e" badword 
bind pub - "a_s_s_h_o_l_e" badword 
bind pubm - "*jancok*" badword 
bind pubm - "asu" badword 
bind pub - "*jancok*" badword 
bind pub - "*jancok*" badword 
bind pubm - "*shit*" badword 
bind pub - "*shit*" badword 
bind pub - "*whore*" badword 
bind pub - "*kontol*" badword 
bind pub - "*contol*" badword 
bind pub - "*pepek*" badword 
bind pub - "*vevek*" badword 
bind pub - "*ngentot*" badword 
bind pub - "*kentot*" badword 
bind pub - "*jembut*" badword 
bind pub - "*zembut*" badword 
bind pub - "*burit*" badword 
bind pub - "*anjing*" badword 
bind pub - "*babi*" badword 
bind pub - "*pukimak*" badword 
bind pubm - "*kontol*" badword 
bind pubm - "*contol*" badword 
bind pubm - "*pepek*" badword 
bind pubm - "*vevek*" badword 
bind pubm - "*ngentot*" badword 
bind pubm - "*kentot*" badword 
bind pubm - "*jembut*" badword 
bind pubm - "*zembut*" badword 
bind pubm - "*vagina*" badword 
bind pubm - "*anjing*" badword 
bind pubm - "*babi*" badword 
bind pubm - "*pukimak*" badword 
bind pubm - "*cibai*" badword 
bind pub - "*cibai*" badword 
bind pubm - "*pantek*" badword 
bind pub - "*pantek*" badword 
bind pubm - "*memek*" badword 
bind pub - "*memek*" badword 

proc badword {nick uhost hand chan arg} { 
global channel { 
if {$hand != "*"} { 
if {([matchattr [nick2hand $dnick] m|n $chan])} 
return 1 
} 
} 
set bmask *!*[string tolower [string range $uhost [string first "@" $uhost] end]] 
putserv "KICK $chan $nick :Watch your mouth!!" 
putserv "MODE $chan +b $bmask" 
} 
putlog "\[Word|KiCk\] v3.0 By \002Yoan\002 is Loaded" 
...
putserv "KICK $channel $nick :\002"Invite Detected !"" 
return 1 
} 
putlog "invite.tcl by Yoan loaded " 
...
putlog "Loaded quitban.tcl v1.0 by Yoan" 
