...
namespace eval ::rss-synd {
	...
	set rss(liputan6) {
		...
		"output"		"0,1 ::8\[0\@@channel!title@@\8\]7\ @@item!pubDate@@\8\ @@item!title@@\7 @@item!description@@\0 0:: 15[ 14Selengkapnya : (\037@@item!guid@@\037\) 8] 0::"
		"trigger"		"!liputan6"
		"evaluate-tcl"	1
	}
	...
	set rss(antara) {
		"url"			"http://www.antara.co.id/rss/news.xml"
		"channels"		"#jatimcom"
		"output"		"0,1 ::8\[0\@@channel!title@@\8\]7\ @@item!pubDate@@\8\ @@item!title@@\7 @@item!description@@\0 0:: 15[ 14Selengkapnya : (\037@@item!guid@@\037\) 8] 0::"
		"database"		"./scripts/antara.db"
		"trigger"		"!antara"
		"evaluate-tcl"	1
	}
	...
	set rss(gosip) {
		...
		"channels"		"#jatimcom"
		"output"		"0,1 ::8\[0\@@channel!title@@\8\]7\ @@item!pubDate@@\8\ @@item!title@@\7 @@item!description@@\0 0:: 15[ 14Selengkapnya : (\037@@item!guid@@\037\) 8] 0::"
		"database"		"./scripts/nba.db"
		"trigger"		"!nba"
		"evaluate-tcl"	1
	}
        
        set rss(Nasional) {
		"url"			"http://www.antara.co.id/rss/nas.xml"
		"channels"		"#jatimcom"
		"output"		"0,1 ::8\[0\@@channel!title@@\8\]7\ @@item!pubDate@@\8\ @@item!title@@\7 @@item!description@@\0 0:: 15[ 14Selengkapnya : (\037@@item!guid@@\037\) 8] 0::"
		"database"		"./scripts/nas.db"
		"trigger"		"!nasional"
		"evaluate-tcl"	1
	}
        
        set rss(Infotainment) {
		"url"			"http://www.antara.co.id/rss/sbh.xml"
		"channels"		"#jatimcom"
		"output"		"0,1 ::8\[0\@@channel!title@@\8\]7\ @@item!pubDate@@\8\ @@item!title@@\7 @@item!description@@\0 0:: 15[ 14Selengkapnya : (\037@@item!guid@@\037\) 8] 0::"
		"database"		"./scripts/sbh.db"
		"trigger"		"!infotainment"
		"evaluate-tcl"	1
        }

        set rss(Mancanegara) {
		"url"			"http://www.antara.co.id/rss/int.xml"
		"channels"		"#jatimcom"
		"output"		"0,1 ::8\[0\@@channel!title@@\8\]7\ @@item!pubDate@@\8\ @@item!title@@\7 @@item!description@@\0 0:: 15[ 14Selengkapnya : (\037@@item!guid@@\037\) 8] 0::"
		"database"		"./scripts/nas.db"
		"trigger"		"!mancanegara"
        ...
        set rss(Teknologi) {
		"url"			"http://www.antara.co.id/rss/tek.xml"
		"channels"		"#jatimcom"
		"output"		"0,1 ::8\[0\@@channel!title@@\8\]7\ @@item!pubDate@@\8\ @@item!title@@\7 @@item!description@@\0 0:: 15[ 14Selengkapnya : (\037@@item!guid@@\037\) 8] 0::"
		"database"		"./scripts/tek.db"
		"trigger"		"!teknologi"
		"evaluate-tcl"	1
	}

        set rss(Ekonomi) {
		"url"			"http://www.antara.co.id/rss/ekb.xml"
		"channels"		"#jatimcom"
		"output"		"0,1 ::8\[0\@@channel!title@@\8\]7\ @@item!pubDate@@\8\ @@item!title@@\7 @@item!description@@\0 0:: 15[ 14Selengkapnya : (\037@@item!guid@@\037\) 8] 0::"
		"database"		"./scripts/ekb.db"
		"trigger"		"!ekonomi"
		"evaluate-tcl"	1
	}
       ...
       set rss(TvOne) {
		"url"			"http://www.tvone.co.id/rss/news/1/Terkini"
		"channels"		"#jatimcom"
		"output"		"0,1 ::8\[0\@@channel!title@@\8\]7\ @@item!pubDate@@\8\ @@item!title@@\7 @@item!description@@\0 0:: 15[ 14Selengkapnya : (\037@@item!guid@@\037\) 8] 0::"
		"database"		"./scripts/tvone.db"
		"trigger"		"!tvone"
		"evaluate-tcl"	1
	}
       ...
       set rss(Okezone) {
		"url"			"http://sindikasi.okezone.com/index.php/news/RSS2.0"
		"channels"		"#jatimcom"
		"output"		"0,1 ::8\[0\@@channel!title@@\8\]7\ @@item!pubDate@@\8\ @@item!title@@\7 @@item!description@@\0 0:: 15[ 14Selengkapnya : (\037@@item!guid@@\037\) 8] 0::"
		"database"		"./scripts/oznews.db"
		"trigger"		"!okezonenews"
		"evaluate-tcl"	1
	}
     
        set rss(MetRoHuKuM) {
		"url"			"http://www.metrotvnews.com/index.php/metromain/rss/hukum"
		"channels"		"#jatimcom"
		"output"		"0,1 ::8\[0\@@channel!title@@\8\]7\ @@item!pubDate@@\8\ @@item!title@@\7 @@item!description@@\0 0:: 15[ 14Selengkapnya : (\037@@item!guid@@\037\) 8] 0::"
		"database"		"./scripts/hukum.db"
		"trigger"		"!metrohukum"
		"evaluate-tcl"	1
	}

        set rss(MetRonasional) {
		"url"			"http://www.metrotvnews.com/index.php/metromain/rss/nasional"
		"channels"		"#jatimcom"
		"output"		"0,1 ::8\[0\@@channel!title@@\8\]7\ @@item!pubDate@@\8\ @@item!title@@\7 @@item!description@@\0 0:: 15[ 14Selengkapnya : (\037@@item!guid@@\037\) 8] 0::"
		"database"		"./scripts/naz.db"
		"trigger"		"!metronasional"
		"evaluate-tcl"	1
	}

        set rss(MetroInter) {
		"url"			"http://www.metrotvnews.com/index.php/metromain/rss/internasional"
		"channels"		"#jatimcom"
		"output"		"0,1 ::8\[0\@@channel!title@@\8\]7\ @@item!pubDate@@\8\ @@item!title@@\7 @@item!description@@\0 0:: 15[ 14Selengkapnya : (\037@@item!guid@@\037\) 8] 0::"
		"database"		"./scripts/inter.db"
		"trigger"		"!metrointer"
		"evaluate-tcl"	1
	}

        set rss(MetrooR) {
		"url"			"http://www.metrotvnews.com/index.php/metromain/rss/olahraga"
		"channels"		"#jatimcom"
		"output"		"0,1 ::8\[0\@@channel!title@@\8\]7\ @@item!pubDate@@\8\ @@item!title@@\7 @@item!description@@\0 0:: 15[ 14Selengkapnya : (\037@@item!guid@@\037\) 8] 0::"
		"database"		"./scripts/olahraga.db"
		"trigger"		"!olahraga"
		"evaluate-tcl"	1
	}

        set rss(MetrooR) {
		"url"			"http://blogbola.com/feed"
		"channels"		"#jatimcom"
		"output"		"0,1 ::8\[0\@@channel!title@@\8\]7\ @@item!pubDate@@\8\ @@item!title@@\7 @@item!description@@\0 0:: 15[ 14Selengkapnya : (\037@@item!guid@@\037\) 8] 0::"
		"database"		"./scripts/blogbola.db"
		"trigger"		"!blogbola"
		"evaluate-tcl"	1
	}
        ...
        set rss(MetrooR) {
		"url"			"http://www.beritabola.com/rss.feed"
		"channels"		"#jatimcom"
		"output"		"0,1 ::8\[0\@@channel!title@@\8\]7\ @@item!pubDate@@\8\ @@item!title@@\7 @@item!description@@\0 0:: 15[ 14Selengkapnya : (\037@@item!guid@@\037\) 8] 0::"
		"database"		"./scripts/blogbola.db"
		"trigger"		"!beritabola"
