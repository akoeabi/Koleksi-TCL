...
#
# Simulates BitchX 1.0c18+ CTCP replies. The version is randomly
...
#
# This script was originally based on bitchxirix.tcl by \[DrAcO\] 
...
proc bx_ctcp {nick uhost hand dest key arg} {
  ...
  switch -exact -- $key {
    ...
    "VERSION" {
      putserv "NOTICE $nick :\001VERSION \002BitchX-1.0c18+\002 by panasync - IRIX 6.5.10 Silicon Graphics :\002 Keep it to yourself!\002\001"
      return 1
    }
    "USERINFO" {
    ...
    "INVITE" {
      ...
      if {((($bx_version == "1.0c18") && ([string trim [string index $chanarg 0] "#+&"] == "")) || (($bx_version == "1.0c18+") && ([string trim [string index $chanarg 0] "#+&!"] == "")))} {
...
proc bx_dccbitchx {hand idx arg} {
  ...
  putidx $idx "bitchxIRIX.tcl $bx_ver by \[DrAcO\]"
...
putlog "Loaded bitchxirix.tcl $bx_ver by \[DrAcO\]"
