...
set repwords {
  ...
  "asl:I'm 16, f, Gujranwala. and you?"
  "heh :%nick: eh?"
  "brb:be back soon!"
  "bye:%nick: Take care!"
  ...
  "from:%nick:I am from Gujranwala"
  "site:%nick:Please visit the http://www.gujranwala.tk for latest news or updates."
...
# End of - Entertainment, Message Auto-Reply. (areply.tcl)
