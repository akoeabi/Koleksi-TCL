...
# !statuse <nick> ?channel?
# !statuse host <hostmask>
#
# DCC command syntax:
...
#  *Set command trigger
#                     +-------+
variable trigger       !statuse
#                     +-------+
#
#  *Set backupfile location/name
#                     +--------------------------+
variable backupfile    "/home/abah/abahkoe/statusd/statusdData.tcl"
#                     +--------------------------+
#
#  *Set configfile location/name
#                     +--------------------------+
variable configfile    "/home/abah/abahkoe/statusd/statusdConfig.tcl"
#                     +--------------------------+
#
