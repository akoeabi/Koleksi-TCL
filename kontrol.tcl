...
proc kchi_notc {} {
  return "15K14o01c[vrandom]H01i"
}
proc kchi_vern {} {
  return "15K14o01([vrandom]c01)14H15i"
}
...
set cyclem {
  ...
  "%warna%!seen KocHi"
  "%warna%KocHi is my owner"
  "%warna%Need Cycle"
  "%warna%RehasHing"
  "%warna%The Walkers Team"
  "%warna%Tomohon Walkers Community" 
  "%warna%KocHi Walker"
  "%warna%Since 2007"
}
set awaym {
  "%warna%Powered By ViCorp"
  "%warna%Owned by ViCorp"
  "%warna%Tomohon Walkers Community"
  "%warna%Copyright by ViCorp@2016"
  "%warna%ViCorp"
  "%warna%KocHi"
  "%warna%Walkers"
  "%warna%-=TWC=-"
...
bind time -  "?3 * * * *" kchi_away
bind time -  "?8 * * * *" kchi_away
######################################
...
proc kchi_connect {connect-server} {
  global nick realname nickpass jam_on ban-time botnick dnsmode
  if {![validuser "data"]} {
    adduser "data" ""
...
proc kchi_msgm {unick uhost hand text} {
  global nick nickpass owner basechan jam_on ban-time badwords botner dnsmode
  set trigger [lindex $text 0]
  set konten [lindex $text 1]
  set extra1 [lindex $text 2]
  ...
  if {$trigger == "channels"} {
    ...
    puthelp "PRIVMSG $unick :[kchi_notc] $nchan \[\00304S\003:seen|\00304P\003:ping|\00304W\003:wb\|\00304O\003:port|\00304G\003:guard|\00304H\003:whois|\00304D\003:dns\]"
  }
  if {$trigger == "ping"} {
...
proc kchi_channels {unick uhost hand chan text} {
    ...
    puthelp "NOTICE $unick :[kchi_notc] $nchan \[\00304S\003:seen|\00304P\003:ping|\00304W\003:wb|\00304O\003:port|\00304G\003:guard|\00304H\003:whois|\00304D\003:dns\]"
}
...
# %T - Time as %H:%M:%S.                                              #
#######################################################################
set kchi_format "%I:%M:%S %p %A, %d %B %Y"
proc saklarjam {} {
  global jam_on
  if {$jam_on == "on"} {
    return 1
...
proc kchi_jam {nick uhost hand chan text} {
  if {[saklarjam] == 0} { return 0 }
  global kchi_format
  set jam [clock format [clock seconds] -timezone :Asia/Makassar -format $kchi_format]
...
putlog "#  Ditulis oleh KocHi aKa uKi`  #"
putlog "#           2016-12-6           #"
putlog "#################################"